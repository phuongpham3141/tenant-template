...
export const NAV_MENU = [
  {
    ...
    items: [
      { name: "Thép & Kim loại",       slug: "ket-cau-thep-khung",          image: "/img/thep-hinh-h-i-u-v.jpg?v=4" },
      { name: "Tấm ốp tường & Trần",   slug: "tam-op-tuong-tran",           image: "/img/cer6.jpg?v=4" },
      { name: "Vật liệu lát sàn",      slug: "vat-lieu-lat-san",            image: "/img/cer7.jpg?v=4" },
      { name: "Đá ốp lát & Nhân tạo",  slug: "da-op-lat",                   image: "/img/da-marble-tu-nhien.jpg?v=4" },
      { name: "Sơn & Lớp phủ",         slug: "son-lop-phu",                 image: "/img/son-epoxy-san.jpg?v=4" },
      { name: "Cách âm & Cách nhiệt",  slug: "vat-lieu-cach-am-cach-nhiet", image: "/img/tam-cach-am.jpg?v=4" },
      { name: "Chống thấm",            slug: "vat-lieu-chong-tham",         image: "/img/mang-chong-tham-bitum.jpg?v=4" },
      { name: "Xi măng & Vữa",         slug: "vat-lieu-kho-xi-mang-vua",    image: "/img/chau-xi-mang.jpg?v=4" },
    ],
  },
  {
    main: { icon: "🛋", name: "Nội thất", slug: "noi-that" },
    items: [
      { name: "Phòng khách",           slug: "phong-khach",         image: "/img/phong-khach.jpg?v=4" },
      { name: "Phòng ngủ",             slug: "phong-ngu",           image: "/img/phong-ngu.jpg?v=4" },
      { name: "Phòng ăn",              slug: "phong-an",            image: "/img/phong-an.jpg?v=4" },
      { name: "Tủ bếp",                slug: "tu-bep",              image: "/img/fur7.jpg?v=4" },
      { name: "Tủ quần áo",            slug: "tu-quan-ao",          image: "/img/fur8.jpg?v=4" },
      { name: "Văn phòng tại nhà",     slug: "van-phong-tai-nha",   image: "/img/van-phong-tai-nha.jpg?v=4" },
      { name: "Nội thất khách sạn",    slug: "noi-that-khach-san",  image: "/img/noi-that-khach-san.jpg?v=4" },
      { name: "Trẻ em & Em bé",        slug: "tre-em-em-be",        image: "/img/tre-em-em-be.jpg?v=4" },
    ],
  },
];
