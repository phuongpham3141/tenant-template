...
export const MIDEA_SERIES_META: Record<string, SeriesMeta> = {
  ...
  "空调": {
    ...
    technicalSpecs: [
      ...
      { label: "能效系数 EER", value: "1 级 —— EER 4.0-4.5（中国标准 GB 21455-2019）" },
      { label: "变频技术", value: "Tropical T3 —— -15°C 至 +52°C 稳定运行" },
      { label: "制冷剂", value: "R32 环保（GWP 675，比 R410A 低 67%）" },
      { label: "空气过滤", value: "PM2.5 HEPA + 触媒 + 负离子 + UV（4 层）" },
      ...
      { label: "机身质保", value: "2 年" },
      { label: "压缩机质保", value: "8 年 —— 行业标准的 2 倍" },
      { label: "使用寿命", value: "12-15 年（美的 7×24 试验台测得）" },
    ],
    manufacturing: [
      ...COMMON_MFG,
      "美的空调工厂 —— 佛山 + 武汉 + 合肥基地 —— 年产量 > 6,000 万台",
      "GMCC 压缩机 100% 自有 —— 不依赖大金、三菱、松下",
      "北京 2022 冬奥会合作 —— 为运动员村 + 赛场供应空调",
    ],
    ...
    installation: [
      ...
      "室内外机最大间距：15 米铜管",
      "最大高度落差：5 米",
      "初次须充足 R32 制冷剂 —— 24 小时后检查压力",
      "夏季每 2 周清洁滤网（越南细颗粒物较高）",
    ],
    certifications: [
      ...COMMON_CERTS,
      "ENERGY STAR（美国）—— 出口北美",
      "AHRI 性能认证",
      "德国 Best Buy Award 2023 —— Midea EU 系列",
      "美国 Cool Vendor 2022 —— 高性价比空调 10 强",
    ],
    packaging: COMMON_PACKAGING,
    whyChoose: [
      {
        icon: "🥇",
        title: "中国市场份额连续 5 年第一",
        desc: "中国市场份额 28.6%（2024）—— 是格力的 2 倍、海尔的 3 倍。全球累计产量 > 3 亿台。",
      },
      {
        icon: "🌡️",
        title: "Tropical T3 —— 热带标准",
        desc: "-15°C 至 +52°C 稳定运行。河内/胡志明夏季 40°C —— 美的仍可在 5 分钟内深度制冷至 16°C。",
      },
      {
        icon: "⚡",
        title: "1 级能效 —— EER 4.5",
        desc: "较定频机省电 30-40%。12㎡ 房间每天用 8 小时，月电费约 15 万越南盾。",
      },
      {
        icon: "🛡️",
        title: "压缩机质保 8 年 —— 行业的 2 倍",
        desc: "GMCC 自产压缩机 + 8 年质保（行业标准 4-5 年）。8 年内压缩机损坏 → 免费换新。",
      },
    ],
    projectShowcase: [
      "北京 2022 冬奥会 —— 全部运动员村 + 赛场（12,000+ 台）",
      "腾讯深圳总部 —— 20 万㎡ 总部采用 VRF Multi-V",
      "广州万豪酒店 —— 850 间客房采用嵌入式 + 风管机",
      "北京大兴机场 —— 大功率商用空调 + 风幕机",
    ],
    faq: [
      ...COMMON_FAQ_BASE,
      {
        q: "美的与大金、三菱在耐用性上相比如何？",
        a: "美的内部 7×24 试验台（由第三方德国 TÜV Rheinland 验证）：美的平均 MTBF 18,000 小时，大金 17,500 小时，三菱 16,000 小时。原因：GMCC 自产压缩机 + 部件配套。价格比日系低 30-40%。",
      },
      {
        q: "能否用于人多的场所（50 人展厅）？",
        a: "可以。商用系列包含 5-10HP 立柜机 + 8-20HP VRF Multi-V。50 人就座（按人均约 600 BTU/人 + 面积 1000 BTU/㎡ 计）→ 需 5-6 HP。欢迎将具体房间规格发给华越报价。",
      },
    ],
  },
  ...
  "冰箱": {
    ...
    heritage:
      "美的于 2016 年收购东芝生活产品及服务公司 —— 在全球运营东芝冰箱业务。拥有东京研发实验室 + 日本若狭工厂 + 佛山工厂。",
    technicalSpecs: [
      { label: "保鲜技术", value: "PT+（Premium Taste）—— 保鲜 7 天（行业标准 3 天）" },
      { label: "负离子杀菌", value: "10⁶ 离子/cm³ —— 杀菌 99.9% + 除味" },
      { label: "-1°C 肉鱼室", value: "无需冻硬即可保鲜 —— 寿司级" },
      { label: "蔬菜室湿度", value: "85-90%（行业标准 70-75%）" },
