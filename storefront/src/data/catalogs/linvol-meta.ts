...
const CERTS = [
  "中国电梯安全国家标准（GB 7588）",
  "家用电梯新标准GB/T 21739-2025",
  "电梯安全检测与验收",
  "按美的集团标准建立的质量管理体系",
];
const MFG = [
  "LINVOL领沃—美的集团旗下官方电梯品牌（美的楼宇科技Midea Building Technologies）",
  "制造商：菱王电梯有限公司（Lingwang Elevator）",
  "美的数字化电梯研发中心+佛山工业园区工厂",
  "数字技术+AI全程应用：设计→生产→定制→研发→运行→维保",
];
const PACK = [
  { label: "供应形式", value: "整套电梯+按项目安装" },
  { label: "定制", value: "轿厢与配置按工程定制" },
  { label: "服务", value: "「管家+专家」—终身质保+维保（热线400-700-7722）" },
];
const INSTALL = [
...
const CARE = [
  ...
  { title: "数字化监控", desc: "数字技术+AI协助监测运行状态，异常早预警。" },
  { title: "安全", desc: "按规定定期进行安全检测；运行异常时立即处理。" },
];
const FAQ = [
  { q: "LINVOL 是美的的品牌吗？", a: "是。LINVOL 领沃是美的集团旗下官方电梯品牌（美的楼宇科技 Midea Building Technologies），制造商为菱王电梯有限公司（Lingwang Elevator）。" },
...
const WHY = { icon: "🛗", title: "美的品牌", desc: "LINVOL——美的集团（《财富》世界500强）旗下官方电梯。" };
