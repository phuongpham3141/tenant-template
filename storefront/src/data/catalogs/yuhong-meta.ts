...
const MFG = [
  "北京东方雨虹 东方雨虹（SZSE 002271）—— 中国最大的防水材料制造商，成立于1995年",
  "在中国设有数十个生产基地；拥有国家级研发与检测实验室体系",
  "沥青/高分子卷材及涂料自动化生产线；按批次质量管控",
  "供应高铁、机场、地铁、水库等重大基础设施项目",
];
const PACK = [
  { label: "卷材", value: "卷宽1m，长10–20m/卷；托盘缠膜" },
  { label: "涂料", value: "20kg/桶（或按厂商规格）" },
...
const FAQ = [
  { q: "雨虹材料有进口用的GB标准吗？", a: "有。提供适用标准（GB）+检测报告；华越供应链协助进口单证。" },
...
export const YUHONG_SERIES_META: Record<string, SeriesMeta> = {
  "membrane-poly": mk({
    ...
    whyChoose: [WHY,
      ...
      { icon: "🛡️", title: "耐化学腐蚀", desc: "耐环境与老化性能好，寿命长。" }],
