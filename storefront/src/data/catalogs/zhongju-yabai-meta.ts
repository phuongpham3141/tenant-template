/**
 * Metadata Zhongju Yabai (Guangdong Zhongju Yabai Building Materials Technology) — meta dùng chung.
 * Nguồn: gdzjyb.com. Nhà sản xuất tấm phủ vô cơ, Tam Thuỷ - Phật Sơn.
 */
...
const BRAND: SeriesMeta = {
  story:
    "Guangdong Zhongju Yabai Building Materials Technology Co., Ltd. chuyên sản xuất tấm phủ vô cơ — còn gọi «tấm băng hỏa» / tấm sạch — vật liệu ốp bề mặt cao cấp cho tường ngăn và trần nội/ngoại thất. Công ty tích hợp R&D, sản xuất và kinh doanh với đội ngũ kỹ thuật giàu kinh nghiệm cùng dây chuyền tự động hoá; đặt tại khu Tam Thuỷ (Sanshui), thành phố Phật Sơn (Foshan), Quảng Đông.",
  heritage:
  ...
  technicalSpecs: [
    { label: "Thương hiệu", value: "Zhongju Yabai (Guangdong Zhongju Yabai)" },
    { label: "Sản phẩm", value: "Tấm phủ vô cơ, tấm ốp tường" },
  ...
  manufacturing: [
    "Guangdong Zhongju Yabai Building Materials Technology — Tam Thuỷ, Phật Sơn",
