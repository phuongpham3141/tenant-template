...
const MFG = [
  "达威尔（广东开平）—— 专业生产手工不锈钢水槽、厨房龙头、地漏（floor drain）及配件",
  "食品级 SUS304 不锈钢水槽；手工（handmade）与拉伸（drawn）两大系列",
...
const FAQ = [
  ...
  { q: "是否提供台面开孔（cut-out）尺寸？", a: "提供。各型号有对应尺寸参数；华越供应链可协助提供安装图纸。" },
...
const SINK = mk({
  ...
  technicalSpecs: [{ label: "材质", value: "食品级 SUS304 不锈钢" }, { label: "工艺", value: "手工（handmade）/ 拉伸（drawn）" }, { label: "特性", value: "底部隔音、防锈、易清洁" }, { label: "款式", value: "单 / 双槽，台下 / 台上" }],
  whyChoose: [WHY, { icon: "🔇", title: "隔音降噪", desc: "底部隔音层降低放水噪音，更安静。" }, { icon: "🧽", title: "易清洁", desc: "R 角合理、表面平滑，清洁快捷。" }],
...
export const DAWEIER_SERIES_META: Record<string, SeriesMeta> = {
  ...
  drain: mk({
    story: "达威尔地漏（floor drain）—— 不锈钢 / 铜防臭地漏，多种侧排与下排款式，排水量大，适用于浴室、阳台、厨房。",
