...
const BRAND: SeriesMeta = {
  story:
    "Guangdong Dongyuan Kitchenware Industrial Co., Ltd.（东原厨具）创立于 1993 年，厂区约 25,000 ㎡，坐落于佛山市顺德区 —— 珠江三角洲的核心工业带。东原专业生产不锈钢厨房水槽、橱柜及卫浴设备；全部产品采用进口高端不锈钢板，防腐蚀。",
  heritage:
    "逾 30 年经验，拥有 400+ 名熟练工人及自有模具设计团队。主营产品：SUS 304 不锈钢水槽（台下/台上、单/双盆、手工款），并取得多项出口认证（UPC、CSA）。",
  technicalSpecs: [
    { label: "品牌", value: "Dongyuan 东原 (Guangdong Dongyuan Kitchenware)" },
    { label: "创立", value: "1993 年（佛山顺德）" },
    { label: "产品", value: "SUS 304 不锈钢水槽、橱柜" },
    { label: "厂区", value: "约 25,000 ㎡，400+ 名工人" },
  ],
  manufacturing: [
    "Guangdong Dongyuan Kitchenware（东原厨具）— 创立于 1993 年，佛山顺德",
    "专业生产不锈钢水槽：台下式（undermount）、台上式（topmount）、手工款（handmade）",
  ...
  installation: [
    "按石材台面选择安装方式：台下式（undermount）、台上式（topmount）或平嵌式（flushmount）",
  ...
  faq: [
    ...
    { q: "有台下式和台上式款型吗？", a: "种类齐全：台下式（undermount）、台上式（topmount）、手工款（handmade），单盆与双盆均有。" },
