...
export const LEAF_CATEGORIES: Record<string, LeafCategoryPage> = {
  "ghe-van-phong": {
    ...
    faqs: [
      ...
      {
        q: "办公椅可以批发采购吗？",
        a: "华越平台上的大多数工厂均支持批发，起订量视型号而定，一般为10–50把。您可提交具体数量的询价，供应商将在24小时内回复CIF/DDP到越南仓的报价。100把以上的订单通常可在挂牌价基础上享受8–15%的折扣。200把以上的订单可提供OEM换标、换皮色、换坐垫服务。",
      },
      {
        q: "如何选择适合自身需求的办公椅？",
        a: "请先明确：（1）每天的久坐时长——4小时以内可选基础职员椅，6小时以上建议选人体工学椅；（2）使用者的身高与体重——椅子须具备合适的升降范围；（3）材质——炎热气候宜选透气网布，空调房则可选皮革/布艺。大批量下单前请先索取样品试用。",
      },
    ],
    filters: [
      {
    ...
    featured: {
      ...
      miniProducts: [
        { title: "YF-A88高端网布人体工学椅", price: "155$-299$", unit: "/套", img: photo("yf1") },
        { title: "意大利头层牛皮大班椅 压铸铝脚", price: "320$-540$", unit: "/套", img: photo("yf2") },
        { title: "钢架可叠放会议椅", price: "65$-110$", unit: "/套", img: photo("yf3") },
        { title: "A字脚布雷绒访客椅", price: "78$-145$", unit: "/套", img: photo("yf4") },
        { title: "YF-A99带搁脚人体工学椅", price: "210$-399$", unit: "/套", img: photo("yf5") },
      ],
    },
    products: [
      {
        ...
        desc: "钢架静电喷涂，德国透气网布，3D S形曲线靠背，4D扶手，3档锁定后仰机构。广东生产，OEM 200pcs+。",
        priceFrom: "30,00$",
        priceTo: "33,00$",
        unit: "/套",
        moq: "1 套",
      ...
      },
      {
        ...
        desc: "1.6mm意大利头层牛皮，天然乳胶坐垫，电池驱动8点按摩系统。5年质保。适合总裁办公室、高端办公场所。",
        priceFrom: "189,00$",
        priceTo: "245,00$",
        unit: "/套",
        moq: "5套",
      ...
      },
      {
        ...
        desc: "BS5852阻燃绒布，钢架静电喷涂，PU模塑坐垫。可叠放10把。是会议室、礼堂、活动区域的理想之选。",
        priceFrom: "18,50$",
        priceTo: "26,00$",
        unit: "/套",
        moq: "20套",
      ...
      {
        id: "ghe-van-phong-4",
        title: "AKF-X3人体工学办公椅 美国网布 铝合金脚 动态腰托",
        desc: "USA Matrex2网布，气压自适应腰托，5D扶手，360旋转头枕。通过BIFMA、GREENGUARD GOLD认证。框架质保12年。",
        priceFrom: "98,00$",
        priceTo: "165,00$",
        unit: "/套",
        moq: "10套",
      ...
      {
        id: "ghe-van-phong-5",
        title: "360旋转职员椅 网布靠背 固定扶手 五星塑料脚",
        desc: "聚酯网布靠背，PU海绵坐垫，PU包覆固定扶手，尼龙五星脚，4级气压杆。适合初创办公室、联合办公空间。",
        priceFrom: "12,80$",
        priceTo: "18,50$",
        unit: "/套",
        moq: "50套",
      ...
      {
        id: "ghe-van-phong-6",
        title: "YAFON YF-A88人体工学办公椅 德国网布 4D头枕 质保10年",
...
function buildLeafFromSeed(slug: string, seed: LeafSeed): LeafCategoryPage {
  ...
  // Products
  const moqPool = ["1 套", "1 个", "5套", "10套", "20 个", "50 个", "100 个", "200 个"];
  const monthLabels = ["4月", "5 月", "新品"];
...
export const HOME_GARDEN_LEAVES: Record<string, LeafSeed> = {
  ...
  "cay-kim-tien-gia": {
    ...
    productNames: [
      ...
      "金钱树 高 150cm 8枝，220片深绿亮叶",
      "金钱树 高 90cm 方形水泥盆 18cm",
      "办公室仿真金钱树双株组合 + 304不锈钢盆",
      "仿真ZZ植物 高70cm，阻燃EVA叶",
      "黑叶变种Raven金钱树 1.2m 热门款",
      "吊顶仿真金钱树 长60cm，不锈钢吊钩",
    ],
    styles: ["现代", "极简", "北欧", "办公"],
    materials: ["真实触感乳胶叶", "抗紫外线 EVA 叶", "PE亮面塑料叶"],
    extraFilters: [
  ...
  "hoa-lan-gia": {
    ...
    productNames: [
      "仿真蝴蝶兰5枝 Phalaenopsis 白色，真实触感硅胶",
      "紫色蝴蝶兰栽盆9枝，景德镇青釉瓷盆",
      "黄色文心兰 长枝65cm，小花3cm，适合花束",
      "仿真石斛兰 多色，长枝50cm，适合瓶插",
      "仿真兜兰 单轴型4枝，附天然干苔藓",
      "真实触感迷你蝴蝶兰三盆组合 前台桌面摆件",
      "特别款翡翠绿蝴蝶兰，5枝70cm栽瓷盆",
      "整枝白兰花90cm 用于酒店大堂大瓶插花",
    ],
    styles: ["古典", "现代", "酒店", "婚礼"],
    materials: ["真实触感硅胶", "涤纶丝绸", "乳胶"],
    extraFilters: [
      { title: "枝数", options: ["3枝", "5枝", "7枝", "9枝", "9枝以上"] },
  ...
  "binh-hoa-lo-hoa": {
    ...
    productNames: [
      "景德镇裂纹釉古典陶瓷花瓶 高45cm，手工彩绘",
      "手工硼硅玻璃花瓶 梨形30cm",
      "红铜金属花瓶 高55cm，复古铜绿做旧效果",
      "白色抽象树脂花瓶 人脸造型35cm",
      "手工藤竹编花瓶40cm，圆口适合插干花",
      "北欧陶瓷花瓶三件套 多尺寸 哑光米白釉",
      "气泡艺术玻璃花瓶 多色28cm",
  ...
  "den-vuon-led": {
    ...
    productNames: [
      "12W LED花园柱灯 高2m，哑光黑静电喷涂铝壳",
      "304不锈钢草坪插地灯 5W LED IP65，3000K暖黄光",
      "50W LED投光灯 IP66 压铸铝壳，用于照射别墅外立面",
      "户外LED灯串 10m IP65，100颗暖白灯珠",
      "RGB变色LED花园灯 8W，蓝牙App控制",
      "圣诞鹿造型LED灯 高1.2m，户外IP44",
      "太阳能LED吊挂灯笼，哑光黑金属壳，4个/套",
      "蘑菇造型花园柱灯 高80cm，铜饰面铝壳",
    ],
    styles: ["现代", "欧式古典", "极简", "工业"],
    materials: ["压铸铝壳", "304 不锈钢", "抗紫外线PC塑料壳"],
    extraFilters: [
      { title: "IP防护等级", options: ["IP44", "IP65", "IP66", "IP67"] },
      { title: "功率", options: ["3-5W", "5-10W", "10-20W", "20-50W", "50W以上"] },
  ...
  "co-banner-trang-tri": {
    ...
    productNames: [
      ...
      "双面活动横幅 50×80cm 600D牛津布",
      "12个月份花园旗套装 抗紫外线涤纶，配螺旋旗杆",
      "涤纶圣诞旗 35×50cm，热升华耐久印刷，不锈钢挂钩",
      "户外数码印刷PVC横幅 1×3m 防水",
      "花园锦鲤鱼尾旗 长1.2m 防水伞布",
      "螺旋花园旗杆 高1m 静电喷涂金属",
      "涤纶万圣节旗 30×45 3D南瓜印花 6件套",
    ],
    styles: ["节日", "四季", "复古", "现代"],
    materials: ["110D涤纶", "600D牛津布", "数码印刷PVC", "伞布"],
    extraFilters: [
  ...
  "do-trang-tri-san-golf": {
    ...
    productNames: [
      ...
      "304不锈钢高尔夫球场指示牌 40×40cm 激光雕刻",
      "铝制码数标志柱 高1.2m，白色静电喷涂",
      "复合材料高尔夫球手造型装饰雕像 高60cm",
      "304不锈钢草坪插地灯 LED 3W IP65，用于高尔夫晚会",
      "铝制果岭旗杆套装 1.8m，不锈钢底座 + 定制Logo旗",
    ],
    styles: ["古典", "现代", "高端"],
  ...
  "chau-nhua-pe": {
    ...
    title: "PE塑料花盆",
    resultsCount: "63.250",
    chips: ["圆形PE盆", "方形PE盆", "长方形PE盆", "吊盆", "仿藤盆", "带排水孔"],
    trendingChips: [
      "长方形阳台PE塑料花盆",
      "60cm高圆形PE盆",
      "50×50cm方形PE盆",
    ...
    productNames: [
      "长方形PE塑料阳台花盆 60×20×18cm，带排水孔",
      "圆形PE盆 高60cm 直径50cm，哑光灰饰面",
      "方形PE盆 50×50×50cm 大堂植物用，真实木底",
      "仿藤圆形PE盆三件套 25-30-35cm，阳台装饰",
      "阳台自浇水PE吊盆 30cm，配黑色金属吊钩",
      "哑光黑PE盆 尺寸80×30×30cm 景观用",
      "迷你圆形PE盆六件套 12cm 米白色 桌面摆件",
      "抗紫外线PE盆 100×40cm，黑色内衬，柱形",
    ],
    styles: ["现代", "极简", "地中海", "北欧"],
    materials: ["滚塑PE塑料", "抗紫外线PE塑料", "仿藤PE"],
    extraFilters: [
      SIZE_FILTER,
  ...
  "chau-composite-soi-thuy-tinh": {
    ...
    title: "复合材料与玻璃纤维花盆",
    resultsCount: "28.940",
    chips: ["GFRC", "Fiberclay", "Fiberglass", "高柱形", "大圆形", "80cm方形"],
    trendingChips: [
      "GFRC复合材料高柱花盆",
      "Fiberclay圆形花盆",
      "80cm高Fiberglass花盆",
    ...
    productNames: [
      "GFRC复合材料高柱花盆 高100cm 直径35cm，花岗岩饰面",
      "Fiberclay圆形花盆 直径60cm 高50cm，哑光灰色调",
      "Fiberglass花盆 高80cm 直径50cm，酒店大堂用",
      "方形复合材料花盆 80×80×80cm 抗紫外线，带排水孔+托盘",
      "唐土陶色Fiberclay花盆 80×40cm，用于大型盆景",
      "花岗岩纹GFRC复合材料花盆 1.2m 别墅景观",
      "海军蓝复合材料柱形花盆两件套 高80-100cm",
      "玻璃纤维花盆 直径1.5m 高60cm，用于大型棕榈",
    ],
    styles: ["现代", "极简", "地中海", "工业"],
  ...
  "chau-gom-su": {
    ...
    title: "陶瓷花盆",
    resultsCount: "37.620",
    chips: ["景德镇", "裂纹釉", "青釉", "手绘", "直径30cm", "直径 50cm"],
    trendingChips: [
      "景德镇陶瓷花盆 40cm",
      "古典裂纹釉陶盆",
      "青釉种兰瓷盆",
  ...
  "chau-inox-kim-loai": {
    ...
    extraFilters: [
      { title: "表面处理", options: ["拉丝", "镜面抛光", "PVD镀金", "古铜做旧"] },
    ],
  },
  ...
  "bon-trong-tu-tuoi": {
    ...
    title: "自浇水花箱",
    resultsCount: "8.130",
    chips: ["阳台", "方形", "长方形", "带吸水芯", "带水位指示", "高30cm"],
    trendingChips: [
      "阳台自浇水花箱",
      "60cm长方形自浇水花箱",
      "带水位指示花箱",
    ...
    productNames: [
      ...
      "3层立式自浇水花箱 高90cm，阳台家庭种菜",
      "圆形自浇水花箱 40cm 高35cm，5L储水芯",
      "长方形自浇水花箱 1m×25cm×25cm，全年种菜",
      "方形露台自浇水花箱 50×50cm，25L储水量",
      "六边形自浇水花箱三件套 25cm 装饰+盆栽",
      "阳台壁挂草莓种植自浇水花箱，6个种植孔",
      "立式自浇水花箱 8孔 高1.4m",
    ],
    styles: ["现代", "极简", "垂直花园"],
    materials: ["原生PP塑料", "PE 塑料", "复合材料"],
    extraFilters: [
      { title: "储水量", options: ["<5L", "5-10L", "10-25L", "25L以上"] },
  ...
  "gia-do-chau": {
    ...
    productNames: [
      "3层金属花盆架 高75cm，哑光黑静电喷涂",
      "北欧橡木4层Z字形花盆架 高110cm",
      "转角立式金属5层花盆架 高1.4m，阳台用",
      "吊顶不锈钢绳挂3层藤蔓装饰花盆架",
      "桌面迷你2层铜金色金属花盆架",
      "松木梯形折叠花盆架 高1.6m",
      "工业风黑色水管4层壁挂花盆架",
    ...
    extraFilters: [
      { title: "层数", options: ["1-2层", "3 层", "4层", "5层以上"] },
  ...
  "phu-tung-dung-cu": {
    ...
    productNames: [
      "SK5硬质钢割草刀片，厚3mm，直径25cm，5片装",
      "2.4mm尼龙割草线，100m卷装，方形扭纹",
      "NGK BPMR7A割草机火花塞，用于25-52cc二冲程发动机",
      "二冲程泡沫空气滤芯，用于36-52cc割草机，5个装",
      "Honda GX35原厂化油器",
      "21V 4Ah锂电池，原装三星电芯，用于割草机+修枝机",
  ...
  "den-solar-san-vuon": {
    ...
    productNames: [
      "IP65太阳能花园灯LED 8W，锂电池3.7V 2400mAh",
      "1.8m高太阳能柱灯，铝壳，一体单晶板6V/3W",
      "304不锈钢太阳能草坪插地灯LED 1W，3000K暖黄光，6个装",
      "60W太阳能投光灯IP66，分体单晶板6V 25W+遥控",
      "10m太阳能灯串100颗LED暖白，8种闪烁模式",
      "人体感应太阳能灯36颗LED IP65，壁挂",
      "RGB变色太阳能灯LED 5W，蓝牙App控制",
      "手工复古太阳能吊挂灯笼，黑色金属壳，4个装",
    ],
    styles: ["现代", "欧式古典", "复古", "极简"],
    materials: ["压铸铝壳", "304 不锈钢", "抗紫外线PC塑料壳"],
    extraFilters: [
      { title: "IP防护等级", options: ["IP44", "IP65", "IP66", "IP67"] },
      { title: "功率", options: ["1-3W", "3-8W", "8-30W", "30-60W", "60W以上"] },
      { title: "电池", options: ["NiMH 600mAh", "锂电池1500mAh", "锂电池2400mAh", "锂电池4800mAh"] },
    ],
  },
  ...
  "den-pha-led-ngoai-troi": {
    ...
    productNames: [
      "50W LED投光灯IP66，黑色压铸铝壳，Bridgelux 5050芯片",
      "100W LED投光灯IP66 SMD 2835芯片，寿命50,000小时",
      "200W球场LED投光灯，光通量22,000lm，IP66",
      "30W COB LED投光灯Bridgelux US芯片，0-10V可调光",
      "30W LED投光灯PIR人体感应12m，IP65",
      "50W RGB LED投光灯App+遥控，1600万色，IP65",
      "60W太阳能LED投光灯分体板，锂电池12000mAh",
      "150W LED投光灯厂房照明IK10抗冲击",
    ],
    styles: ["工业", "现代", "运动场"],
    materials: ["压铸铝壳", "静电喷涂铝壳", "钢化玻璃"],
    extraFilters: [
      { title: "功率", options: ["10-30W", "30-50W", "50-100W", "100-200W", "200W以上"] },
  ...
  "moc-treo-ke-tuong": {
    ...
    extraFilters: [
      { title: "安装方式", options: ["3M 粘胶", "钻孔螺丝", "门挂"] },
  ...
  "tui-vai-gio-dung": {
    ...
    productNames: [
      ...
      "OEM印Logo 12oz帆布购物袋，长提手60cm",
      "藤竹编儿童玩具收纳篮 35cm",
      "80g无纺布袋 4色印刷，尺寸40×30cm",
      "棉+铁洗衣篮 高65cm，带盖+滚轮",
      "手工印花帆布手提袋，尺寸38×42cm",
      "网布可折叠脏衣收纳篮 65L 2格分类",
      "600D帆布带拉链多功能布袋，容量45L",
    ],
    styles: ["北欧", "复古", "现代", "波西米亚"],
    materials: ["100%纯棉", "12oz 帆布", "80g无纺布", "藤竹编", "网布"],
    extraFilters: [
  ...
  "san-pham-giat-la": {
    ...
    productNames: [
      "304不锈钢2层可折叠晾衣架，长1.6m，承重30kg",
      "304不锈钢3层带轮晾衣架，折叠后宽50cm",
      "棉+铁洗衣篮 65L 带盖+提手",
      "PP塑料晾衣夹30个装，不锈钢弹簧",
      "铝制阳台壁挂伸缩晾衣架 1.4m",
      "304不锈钢小型X型折叠晾衣架 公寓阳台用",
      "帆布+铁3格洗衣分类篮",
      "ABS塑料16夹晾袜架，不锈钢弹簧夹",
    ],
    styles: ["极简", "工业", "现代"],
  ...
  "san-pham-ve-sinh-nha-cua": {
    ...
    productNames: [
      "360°旋转自动甩干拖把，超细纤维拖头4个替换装",
      "1500W蒸汽拖把，350ml水箱，杀菌用",
      "合成纤维无尘扫把 + 铝柄 长1.2m",
      "超细纤维抹布6件套 30×30cm 300gsm，多用途",
      "PP塑料起泡喷壶500ml，用于稀释皂液+化学剂",
      "多功能清洁6件套：拖把+扫把+抹布+甩干桶",
      "双面磁吸擦玻璃器 用于高层公寓窗户",
      "木+合成纤维静电除尘掸，长80cm",
    ],
    styles: ["现代", "极简"],
  ...
  "qua-tang-thu-cong-noel": {
    ...
    title: "圣诞礼品与手工艺品",
    resultsCount: "84.620",
    chips: ["圣诞树", "门挂花环", "圣诞球", "圣诞LED灯", "驯鹿摆件", "装饰套装"],
    trendingChips: [
      "PVC圣诞树1.8m",
      "手工圣诞门挂花环",
      "圣诞树装饰套装50件",
    ...
    productNames: [
      "PVC圣诞树1.8m 1,200枝，金属底座，礼盒装",
      "手工圣诞门挂花环 直径50cm，松针+圣诞球",
      "圣诞树装饰套装50件：圣诞球+丝带+树顶星+灯串",
      "圣诞球24件套 直径6cm 哑光金，礼盒装",
      "圣诞LED灯串10m 100颗暖白IP44，插头",
      "门口驯鹿装饰摆件3件套 高30-50-70cm",
      "预装灯圣诞树 高2.1m 预装350颗暖光LED",
      "天鹅绒手工圣诞袜6件套 可绣名字",
    ],
  ...
  "do-thu-cong-halloween": {
    ...
    title: "万圣节手工艺品",
    resultsCount: "32.140",
    chips: ["LED南瓜", "树脂幽灵摆件", "蜘蛛网", "恐怖LED灯", "面具", "门口装饰套装"],
    trendingChips: [
      "塑料LED万圣节南瓜",
      "树脂幽灵摆件",
      "装饰蜘蛛网",
    ...
    productNames: [
      "塑料LED万圣节南瓜，直径25cm，橙黄灯光",
      "手工树脂幽灵摆件，高50cm，内置LED灯光",
      "万圣节装饰蜘蛛网，3.6×3.6m，附100只塑料蜘蛛",
      "橙+紫万圣节LED灯串，10m，100颗，IP44",
      "乳胶橡胶僵尸造型万圣节面具，8款",
      "万圣节门口装饰8件套：南瓜+幽灵+蜘蛛网",
      "万圣节门挂花环，直径45cm，带LED+南瓜",
      "充气花园南瓜，高2.4m，带LED+12V风机",
    ],
  ...
  "do-tiec-trang-tri-su-kien": {
    ...
    productNames: [
      "Happy Birthday气球套装，50个+横幅+丝带，金黑主题",
      "数字铝膜气球，高1m，氦气级，可填充LED",
      "活动背景仿真花拱门，2.5m，丝绸花+绿叶",
      "牛皮纸+丝带复古生日横幅，可印名字+年龄数字",
      "派对彩纸套装，5色，1,000片+6个礼炮",
      "迎婴派对主题纸杯纸盘套装，60件，4种粉彩色",
      "迎婴派对气球套装，70个，4种尺寸+拱门套件",
  ...
  "thu-cong-nhua-resin": {
    ...
    productNames: [
      "手工树脂天使雕像，高30cm，金属金喷涂",
      "手工树脂相框A4，金色边框，嵌珍珠",
      "镀金环氧树脂杯垫6件套，直径10cm",
      "环氧树脂首饰套装，含手镯+项链+耳环",
      "桌面树脂雕像三件套，狮+象+马",
      "迷你动物树脂摆件6件套，高8-12cm，用于生态缸",
      "环氧树脂永生干花瓶，玫瑰+满天星",
      "招财猫Maneki-Neko树脂雕像三件套，金箔色，18cm",
    ],
    styles: ["现代", "复古", "奢华金", "北欧"],
  ...
  "thu-cong-kim-loai": {
    ...
    styles: ["工业", "复古", "新古典", "北欧"],
    materials: ["铸铜", "锻铁", "手工切割304不锈钢", "镀金合金"],
    extraFilters: [
      { title: "表面处理", options: ["古黄铜", "铜绿做旧", "PVD镀金", "哑光黑喷粉"] },
    ],
  },
  ...
  "o-du-leu-bai": {
    ...
    styles: ["度假村", "北欧", "现代"],
    materials: ["250D 涤纶布", "600D牛津布", "Sunbrella 面料", "铝合金框架", "钢框架"],
    extraFilters: [
  ...
  "xe-day-vuon": {
    ...
    styles: ["家用", "半专业", "农场"],
    materials: ["静电喷涂钢框架", "PE 车斗", "600D牛津布", "PU 实心轮"],
    extraFilters: [
      { title: "载重", options: ["<100kg", "100-200kg", "200-300kg", "300kg 以上"] },
      { title: "轮式", options: ["单轮", "双轮", "4 轮", "电动"] },
    ],
  },
  ...
  "trang-tri-trong-nha": {
    ...
    productNames: [
      "碧玉阿弥陀佛像 30cm 手工雕刻，紫檀木底座",
      "景德镇裂纹釉陶瓷花瓶 高45cm，手绘水墨",
      "铝框仿真植物墙 60×60cm，抗紫外线EVA叶 5年不褪色",
      "抽象帆布画框三联 40×60cm，橡木边框",
      "北欧圆形装饰镜 Φ80cm，PVD镀金304不锈钢边框",
      "弧形陶瓷台灯 45cm，亚麻布灯罩，E27灯泡",
      "招财猫Maneki-Neko三件套 金箔色树脂 18cm 防潮",
      "MDF木条挂钟 50cm，日本原装扫秒机芯",
    ],
    styles: ["现代", "北欧", "新古典", "极简", "佛教", "轻奢"],
    materials: ["树脂", "陶瓷", "304 不锈钢", "复合材料", "亚克力贴面MDF", "涤纶丝绸"],
    extraFilters: [
      SIZE_FILTER,
  ...
  "trang-tri-san-vuon": {
    ...
    productNames: [
      "整石花岗岩石狮雕像 高1.2m，耐风雨20年",
      "3层喷泉 直径1.5m 复合材料人造石饰面",
      "LED太阳能草坪插地灯 6件套 1W IP65，锂电池1200mAh",
      "304不锈钢镜面抛光花园反光球 Φ30cm",
      "PU塑料希腊花园墙浮雕 80×120cm 防水",
      "鲤鱼跃龙门复合材料雕像 60cm，人造石饰面",
  ...
  "phong-khach-trang-tri": {
    ...
    productNames: [
      ...
      "茶几装饰5件套：木托盘 + 蜡烛 + 雕像 + 花瓶 + 书",
      "4扇橡木框屏风 高1.8m，金色磨砂膜面",
    ],
  ...
  "phong-an-khach-san": {
    ...
    productNames: [
      "K9水晶宴会厅吊灯 Φ1.2m，24头E14 + 可调光LED",
      "3m长桌中心摆件套装5件：花瓶 + 蜡烛 + 镜面底座",
      "陶瓷餐桌花瓶 高35cm 哑光米色，宽口插鲜花",
      "MDF木胡桃木贴面CNC阿拉伯纹隔断 2.4×1.2m",
      "304不锈钢自助餐托盘 GN 1/1 深65mm，哑光防指纹面",
      "餐饮帆布墙画三联 60×90cm，东方美食主题",
      "5头黄铜烛台 高60cm，宴会用",
      "8cm方形陶瓷胡椒盐瓶，24对装，五星酒店Logo",
    ],
    styles: ["国际五星", "新古典", "东方", "轻奢", "餐饮工业"],
    materials: ["K9水晶", "304 不锈钢", "哑光釉陶瓷", "铸铜", "胡桃木贴面"],
    extraFilters: [
    ...
    featuredSupplier: {
      ...
      products: [
        { title: "K9宴会厅吊灯 1.2m", price: "$420–680/个" },
        { title: "3m宴会中心摆件套装", price: "$120–185/套" },
      ],
    },
  },
  ...
  "ban-cong-san-thuong": {
    ...
    materials: ["铝合金框架", "静电喷涂钢", "WPC", "PE 塑料", "600D牛津布"],
    extraFilters: [
  ...
  "khu-vuc-sanh": {
    ...
    materials: ["K9水晶", "花岗岩", "玻璃纤维", "木贴面", "人造石 Solid Surface"],
    extraFilters: [
  ...
  "chau-hoa-bon-cay": {
    ...
    productNames: [
      "圆形复合材料花盆 高60cm Φ50cm，多色环氧喷涂，底部排水孔",
      "长方形PE塑料花箱 80×30×35cm，抗紫外线8年，可拆脚",
      "景德镇白釉陶瓷花盆 高40cm，手绘蓝色花纹",
      "方形水泥花盆 50×50×50cm，天然磨砂表面，防霉",
      "圆柱形304不锈钢花盆 高70cm，天然柚木底防腐",
      "方形玻璃纤维花盆 40×40×40cm，哑光饰面，12色",
      "PP阳台自浇水花箱 60×25cm，4L储水箱，毛细导水管",
      "ABS塑料栏杆吊盆三件套，可调不锈钢挂钩0–180mm",
    ],
  ...
  "binh-hoa": {
    ...
    productNames: [
      "手工吹制喇叭口玻璃花瓶 高25cm，古铜金底座",
      "景德镇裂纹釉陶瓶 高45cm，手绘水墨",
      "客厅陶瓷落地花瓶 高80cm，宽口插鲜花",
      "床头迷你花瓶 12cm 哑光米色，同色调三件套",
      "PVD镀金黄铜金属花瓶 高30cm，窄口插单枝",
      "北欧哑光罗纹陶瓷花瓶 高28cm，6种粉彩混色",
      "波西米亚K9水晶切棱花瓶 高22cm，底厚15mm 高端",
      "现代白色人脸抽象树脂花瓶 35cm，哑光环氧饰面",
    ],
    styles: ["现代", "北欧", "新古典", "中式", "复古", "轻奢"],
    materials: ["硼硅玻璃", "陶瓷", "黄铜金属", "K9水晶", "树脂"],
    extraFilters: [
      SIZE_FILTER,
  ...
  "vat-pham-trang-tri": {
    ...
    productNames: [
      ...
      "PVD镀金镜面装饰托盘 长方形40×25cm，304不锈钢边框",
      "3头铜烛台 高60cm，宴会或玄关桌用",
      "北欧小熊造型陶瓷纸巾盒 25cm，哑光白釉",
      "镀金埃菲尔铁塔模型 32cm，白色大理石底座",
      "反光玻璃球 Φ20cm，圆形胡桃木底座",
      "复古硬壳装饰假书 5本套，用于装饰柜",
      "哑光陶瓷装饰瓶三件套，高15-20-25cm 同色调",
    ],
  ...
  "vat-lieu-nhua-pe": {
    ...
    productNames: [
      ...
      "240L PE 公园垃圾桶 3格分类，V0阻燃",
      "HDPE 70% 抗紫外线遮阳网 5×3m，厚0.45mm，不锈钢扣眼",
      "105孔 PE育苗盘 54×28cm，农场播种育苗用",
      "1000L PE储水箱，5mm食品级，防藻",
      "方形PE有机蔬菜种植箱 30×30cm，带脚+底托",
    ],
    styles: ["热带", "工业", "极简"],
    extraFilters: [
      SIZE_FILTER,
      { title: "PE级别", options: ["LDPE", "HDPE", "LLDPE", "滚塑PE", "食品级PE"] },
  ...
  "vat-lieu-gom-su": {
    ...
    productNames: [
      "景德镇裂纹釉陶瓶 高45cm，100%手绘水墨",
      "白釉陶瓷花盆 高40cm，宽口手绘蓝色花纹",
      "青釉陶瓷阿弥陀佛像 30cm，紫檀木底座",
      "摩洛哥装饰瓷砖 6片20×20cm，钴蓝釉墙面铺贴",
      "北欧哑光罗纹陶瓷瓶 高28cm，6种粉彩色",
      "龙泉碧玉青釉茶具套装 9件，木质礼盒",
      "北欧小熊造型陶瓷纸巾盒，哑光白釉 25cm",
      "裂纹釉陶瓷台灯 高45cm，亚麻布灯罩，E27灯泡",
    ],
  ...
  "vat-lieu-da-tu-nhien": {
    ...
    productNames: [
      "整石花岗岩石狮雕像 高1.2m，抛光/磨砂双面",
      "3层石喷泉 直径1.5m，山东花岗岩",
      "花园砂岩浮雕 80×120cm，手工雕刻罗马纹",
      "圆形洞石花盆 高40cm Φ35cm，天然亚光饰面",
      "圆形大理石桌 Φ80cm 厚30mm，黄铜金属脚",
      "CNC石碑雕刻 60×40cm，山东G684黑花岗岩",
    ...
    featuredSupplier: {
      ...
      products: [
        { title: "1.2m花岗岩石狮雕像", price: "$580–880/对" },
        { title: "1.5m 三层石喷泉", price: "$1,250–1,850/套" },
      ],
    },
  },
  ...
  "vat-lieu-kim-loai-son-tinh-dien": {
    ...
    productNames: [
      "黑色静电喷涂钢阳台小酒馆桌椅套装，桌面60cm",
      "黑色静电喷涂方钢栏杆40×40，双层防锈",
      "户外喷涂钢花盆高50cm，抗紫外线环氧喷涂8年",
      "静电喷涂铁艺门门扇1.5m，CNC花纹",
      "1.8m公园长椅喷涂钢架，WPC防腐面板",
      "户外喷涂钢货架5层60×30×180cm，每层承重50kg",
      "喷涂钢凉棚框架3×3m，600D牛津防水布顶",
      "黑色金属三层花盆架80cm，磨砂环氧喷涂",
    ],
    styles: ["工业", "现代", "法式复古", "极简"],
    extraFilters: [
      { title: "喷涂等级", options: ["单层", "双层环氧+聚酯", "三层船用级", "C5防锈"] },
      { title: "喷涂颜色", options: ["黑色RAL 9005", "白色RAL 9010", "灰色RAL 7016", "复古铜色", "可定制"] },
      { title: "质保", options: ["2年", "5 年", "10 年"] },
    ],
  },
  ...
  "vat-lieu-soi-thuy-tinh": {
    ...
    productNames: [
      "方形玻璃纤维花箱40×40×40cm，哑光饰面12色",
      "圆形玻璃纤维花盆高60cm Φ50cm，船用级胶衣层",
      "酒店大堂玻璃纤维女神雕像高1.8m，仿大理石喷涂",
  ...
  "vat-lieu-inox-304": {
    ...
    productNames: [
      ...
      "户外304不锈钢桌椅套装1+4，HPL紧凑岩板防雨台面",
      "镜面304不锈钢抽象雕像高1.5m，黑花岗岩底座",
      "304不锈钢自助餐托盘GN 1/1深65mm，厚0.8mm，NSF认证",
      "镜面抛光304不锈钢花园反光球Φ30cm",
      "拉丝缎面304不锈钢扶手Φ42.4长6m，90°灵活接头",
      "304不锈钢景观灯柱高3m，双头LED 60W IP66",
    ],
    styles: ["现代", "工业", "轻奢", "国际五星"],
    extraFilters: [
      { title: "表面处理", options: ["镜面", "拉丝缎面", "PVD镀金", "PVD镀铜", "PVD镀黑"] },
      { title: "不锈钢级别", options: ["304", "304L", "316", "316L（船用级）"] },
      { title: "认证", options: ["NSF（食品级）", "ISO 9001", "EN 1090", "CE", "RoHS"] },
    ],
  },
};
...
const CATEGORY_TEMPLATES: Record<string, CategoryTemplate> = {
  electrical: {
    variants: [
      "16A 250V符合IEC标准，V0阻燃PC外壳",
      "欧标暗装，镀镍铜体",
      "ELCB 30mA防触电技术",
      "户外IP65防水版本",
      "集成USB-C 20W及Type-A 2.4A接口",
      "OEM印Logo，独立展示盒包装",
      "2026款，附CE/CCC/TÜV标识",
      "质保5年，起订量灵活",
    ],
    styles: ["欧标", "美式", "英标BS", "日标JIS", "国标"],
    materials: ["阻燃PC塑料", "铝合金", "镀镍铜", "不锈钢", "静电喷涂金属"],
  },
  lighting: {
    variants: [
      "Bridgelux COB LED芯片9W-36W，CRI≥80",
      "3000K/4000K/6500K色温可调",
      "压铸铝散热壳，浴室IP44",
      "集成调光器+涂鸦智能Wi-Fi",
      "寿命50,000小时，质保3年",
      "按需OEM ODM——驱动器印Logo",
    ...
    materials: ["压铸铝", "轻合金", "PMMA亚克力", "硼硅玻璃", "静电喷涂钢"],
  },
  "bathroom-sanitary": {
    variants: [
      "实心黄铜，5层PVD镀铬",
  ...
  "doors-windows": {
    variants: [
      "6063-T5铝框厚1.4mm，静电喷涂",
      "Low-E+氩气双层玻璃，隔热U=1.6",
      "双轨静音防尘推拉，EPDM密封条",
      "Roto/Sheba/Hopo高端配件",
      "按图定制尺寸，起订量1套",
      "IP65防水，抗12级风",
      "OEM印Logo，出口托盘包装",
      "2026款，通过CE/AAMA/WERS-A认证",
    ],
    styles: ["铝合金系统门", "兴发铝门", "Bertelsmann铝门", "钢化玻璃门", "复合木门"],
    materials: ["6063铝", "静电喷涂钢", "钢化玻璃", "MDF木贴面", "uPVC塑料"],
  },
  "construction-materials": {
    variants: [
      "瓷砖600×600/800×800/1000×1000mm",
      "哑光/亮光/砂岩釉面，R10防滑",
      "抗折强度 ≥35 N/mm²，吸水率 <0.5%",
      "2026大理石/花岗岩/水泥纹色调",
      "1.4吨托盘包装，40HQ集装箱装运",
      "砖底OEM型号+Logo",
      "CE/ISO 13006/A1级防火认证",
      "质保25年不褪色",
    ],
  ...
  "hardware-tools": {
    variants: [
      "304/316不锈钢，抗海水腐蚀",
      "800-2200W有刷电机，转速可调",
      "18V/20V/40V锂电池，2-6Ah，1小时快充",
      "镁铝合金抗冲击外壳IP54",
      "软胶防滑手柄，减震60%",
      "机身激光雕刻OEM Logo",
      "附吹塑工具箱，配件齐全",
      "通过CE/GS/EMC/RoHS认证，质保2年",
    ],
    styles: ["专业", "家庭DIY", "工业"],
  ...
  "hotel-supplies": {
    variants: [
      "100%埃及长绒棉60S/2，600支纱线密度",
      "白鹅绒90/10，厚200gsm",
      "5cm涤纶记忆棉，ProBact抗菌",
      "尺寸King 200×220cm/Queen 180×200cm",
      "OEM绣Logo，精品酒店起订50套",
      "通过OEKO-TEX 100/ISO 9001/Greenguard认证",
      "单件polybag包装+出口托盘",
      "质保2年防起球、不褪色",
    ],
  ...
  "outdoor-garden": {
    ...
    materials: ["6063铝", "PE-HDPE 藤编", "天然柚木", "304 不锈钢", "塑木 Polywood", "花岗岩"],
  },
  "noi-that": {
    variants: [
      ...
      "OEM 供酒店 / 公寓 / 展厅项目",
      "平板包装，组装 <30 分钟",
      "通过 FSC / CARB-P2 / E0 甲醛排放认证",
      "框架质保 10 年，面料质保 3 年",
    ],
    styles: ["现代", "北欧", "新古典", "日韩极简", "工业"],
    materials: ["天然橡木", "胡桃木", "MDF木贴面", "天然乳胶垫", "天鹅绒面料", "PU 皮"],
  },
  "home-garden": {
    variants: [
      "高端材料，喷粉涂层 7 年防褪色",
