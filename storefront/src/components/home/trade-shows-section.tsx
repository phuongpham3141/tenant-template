...
const FEATURED: TradeShow = {
  ...
  badge: "NỔI BẬT",
  category: "Tổng hợp · 25K+ nhà cung cấp",
  href: "/trade-shows",
};
...
const SHOWS: TradeShow[] = [
  ...
  },
  {
    ...
    location: "Thượng Hải, Trung Quốc",
    category: "Nội thất & Đồ gia dụng",
    href: "/trade-shows",
  },
];

export async function TradeShowsSection() {
  const t = await getT();
