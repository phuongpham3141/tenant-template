...
export const ARTICLES: BlogArticle[] = [
  {
    ...
    featured: true,
    content: [
      { type: "p", text: "Tháng 3/2026, Hiệp hội Gốm sứ Quảng Đông công bố giá xuất xưởng trung bình ngành gốm sứ Foshan tăng 8% so với cùng kỳ năm trước. Đội Sourcing Huayuesc đã làm việc trực tiếp với 14 nhà máy đối tác tại Foshan trong 4 tuần qua để hiểu nguyên nhân và đưa ra khuyến nghị cho buyer Việt Nam." },
      ...
      { type: "list", items: [
        ...
        "Đàm phán hợp đồng năm — Huayuesc đang giúp 8 đại lý Việt Nam khoá giá theo hợp đồng năm với 3 NCC top tier.",
      ...
      { type: "p", text: "Dài hạn (2027+), Huayuesc dự báo giá ổn định trở lại khi LNG có nguồn cung mới từ Mỹ và các NCC chuyển sang lò điện. Đây cũng là cơ hội để các NCC trung-nhỏ áp dụng công nghệ mới, có thể giảm 5-10% chi phí và competitive hơn." },
    ],
  },
  {
    slug: "canton-fair-2026-phase-1-5-san-pham-viet-nam-nen-san",
    title: "Canton Fair 2026 — 5 sản phẩm Việt Nam nên săn",
    excerpt: "Từ 15/04 đến 05/05, Canton Fair phase 1 sẽ giới thiệu hàng nghìn sản phẩm mới. Huayuesc dẫn đoàn 30 buyer Việt Nam — đây là 5 ngành hàng được dự báo hot nhất.",
    category: "hoi-cho",
    ...
    content: [
      { type: "p", text: "Canton Fair (Quảng Châu Spring Fair) phase 1 diễn ra từ 15/04 đến 05/05/2026 tại Pazhou Complex, Quảng Châu — sự kiện B2B lớn nhất thế giới với 25,000+ exhibitor và 200,000+ buyer toàn cầu. Huayuesc dẫn đoàn 30 buyer Việt Nam tham dự, bao gồm visa support, lịch B2B match-making với 80+ NCC pre-screened." },
      ...
      { type: "quote", text: "Canton Fair không phải nơi mua hàng — đó là nơi gặp NCC, xem mẫu, đàm phán hợp đồng năm. Đoàn 30 buyer của Huayuesc năm nay tập trung vào đàm phán dài hạn thay vì spot order.", author: "Nguyễn Văn Đức — Sourcing Director" },
      { type: "h2", text: "Đăng ký tham gia đoàn" },
      { type: "p", text: "Huayuesc support 30 suất, mỗi suất bao gồm: visa Trung Quốc free, vé máy bay Hà Nội-Quảng Châu khứ hồi, khách sạn 4 sao 5 đêm gần Pazhou, lịch B2B match-making 1-on-1 với 80+ NCC, phiên dịch tiếng Trung 1 buyer-1 phiên dịch, transfer xe đến hội chợ. Phí đoàn $850/người (giá thị trường $2,500). Đăng ký trước 31/03." },
    ],
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Đáng chú ý: HS 9403.10 (đồ gỗ kim loại) vẫn giữ thuế 25%; HS 4419 (đồ gỗ nhà bếp nhỏ) vẫn 30%. Buyer nên kiểm tra HS code chính xác qua Huayuesc logistics team trước khi đặt." },
      ...
      { type: "p", text: "Buyer tiết kiệm $1,320 (gần 4%) cho mỗi $20K đơn nội thất gỗ. Với showroom làm 5-10 đơn/năm, mức tiết kiệm là $7,000-13,000 — bằng đúng phí Premium Membership của Huayuesc." },
      ...
      { type: "list", items: [
        ...
        "Huayuesc cập nhật calculator DDP với thuế mới — xem tại /info/ddp-calculator.",
      ]},
    ],
  },
  {
    slug: "case-study-showroom-sai-gon-tiet-kiem-22-percent",
    title: "Case study: Showroom Sài Gòn tiết kiệm 22% nhờ chuyển sang Huayuesc",
    excerpt: "Showroom Sài Gòn (TP HCM) chuyển từ broker truyền thống sang Huayuesc cho 18 đơn năm 2025. Phân tích chi tiết: giá nguồn, cước, thuế, dispute.",
    category: "case-study",
    ...
    content: [
      { type: "p", text: "Showroom Sài Gòn (giấu tên thật theo yêu cầu) là chuỗi nội thất 6 cửa hàng tại TP HCM với doanh thu 2025 đạt 45 tỷ đồng, chuyên sofa + bàn ghế ăn nhập khẩu Trung Quốc. Trước 2024, họ làm việc qua một broker tại Quảng Châu (commission 12%, không transparent). Năm 2025, họ chuyển 18 đơn hàng (tổng giá trị $480K) sang Huayuesc. Đây là phân tích chi tiết." },
      ...
      { type: "h2", text: "Cấu trúc chi phí sau (Huayuesc)" },
      { type: "table", headers: ["Hạng mục", "% giá nhập", "Ghi chú"], rows: [
        ["Giá hàng FOB Foshan", "100%", "Báo giá trực tiếp từ NCC qua RFQ"],
        ["Huayuesc commission", "0%", "NCC trả 5%, không tính buyer"],
  ...
  },
  {
    ...
    content: [
      { type: "p", text: "Buyer Việt Nam ở miền Bắc thường đối mặt câu hỏi: nhập hàng qua cảng Lạch Huyện (Hải Phòng) hay vẫn theo thói quen qua Cát Lái (TP HCM) rồi vận chuyển ra Bắc? Phân tích chi tiết Q1/2026 dựa trên dữ liệu 240 đơn DDP của Huayuesc." },
      ...
      { type: "p", text: "Đối với hàng nhỏ (<5 CBM) hoặc cần thời gian giao cực ngắn (5-7 ngày tổng), Huayuesc có route đường bộ qua Cửa khẩu Hữu Nghị (Lạng Sơn). Cước $80-120/CBM, gấp đôi đường biển nhưng nhanh hơn 5-7 ngày. Phù hợp với showroom cần cập nhật mẫu nhanh hoặc hàng hot." },
      { type: "quote", text: "80% buyer Bắc của Huayuesc đã chuyển qua Lạch Huyện trong 2025. Tiết kiệm thực tế trung bình $1,200-1,500/container — dùng đó nâng cấp packaging hoặc giảm giá retail.", author: "Đặng Thanh Hà — Logistics Coordinator" },
      { type: "h2", text: "Kế hoạch 2026" },
      { type: "p", text: "Huayuesc đang đầu tư mở văn phòng đại diện tại Hải Phòng (Q3/2026) để rút ngắn thời gian giao DDP về kho buyer Bắc xuống 7-9 ngày. Đồng thời, ký MOU với 2 forwarder lớn tại Lạch Huyện để có ưu đãi cước cố định cho buyer Huayuesc. Buyer trên nền tảng sẽ được benefit này tự động." },
    ],
  },
  {
    slug: "huayuesc-ai-sourcing-llm-matching-beta",
    title: "Huayuesc ra mắt AI Sourcing — LLM matching beta",
    ...
    content: [
      { type: "p", text: "Huayuesc chính thức phát hành tính năng AI Sourcing — sử dụng LLM (large language model) để hiểu RFQ tiếng Việt phức tạp và tự động match với NCC phù hợp nhất trong database 4,200+ nhà máy đối tác. Beta test miễn phí cho 100 buyer đầu tiên đăng ký từ 05/04/2026." },
  ...
  },
  {
    ...
    excerpt: "Cửa khẩu Hữu Nghị nâng cấp infrastructure Q1/2026, Huayuesc ký MOU với 2 forwarder để cung cấp DDP đường bộ 5-7 ngày từ Foshan/Quảng Châu.",
    category: "san-pham-moi",
    author: "Đặng Thanh Hà",
    authorRole: "Logistics Coordinator",
    date: "2026-03-30",
    ...
    content: [
      { type: "p", text: "Sau cải tạo cửa khẩu quốc tế Hữu Nghị (Lạng Sơn) hoàn thành 02/2026 với hệ thống e-customs mới, Huayuesc ký MOU với 2 forwarder lớn (Sinotrans + Vinatrans) để cung cấp gói DDP đường bộ với thời gian giao 5-7 ngày — nhanh hơn đường biển 7-10 ngày." },
      ...
      { type: "p", text: "Để đặt DDP đường bộ qua Huayuesc, chọn 'Đường bộ Lạng Sơn' trong calculator /info/ddp-calculator hoặc note rõ trong RFQ. Đội Logistics CSR tự động phân tích và đề xuất route tối ưu." },
    ],
  },
  {
    slug: "oppein-home-profile-top-1-chau-a",
    title: "OPPEIN Home — Profile NCC tủ bếp số 1 châu Á",
    excerpt: "OPPEIN Home Group (Quảng Châu) là nhà sản xuất tủ bếp số 1 châu Á với doanh thu $4.2B năm 2025. Huayuesc phỏng vấn CEO và đi tour nhà máy 200,000m².",
    ...
    content: [
      { type: "p", text: "OPPEIN Home Group thành lập 1994 tại Quảng Châu, hiện là nhà sản xuất tủ bếp + tủ quần áo + nội thất nguyên căn lớn nhất châu Á. Doanh thu 2025: $4.2B với 6,200+ nhân viên và 4 khu phức hợp sản xuất tổng diện tích 200,000m². Huayuesc vừa hoàn thành audit định kỳ Q1/2026 và phỏng vấn deputy CEO Mr. Chen Liang. Đây là profile chi tiết." },
      ...
      { type: "h2", text: "Why work with OPPEIN qua Huayuesc" },
      { type: "list", items: [
      ...
      { type: "p", text: "Q4/2025, một developer căn hộ tại Hồ Tây (Hà Nội) đặt 280 bếp OPPEIN dòng Modern Italian qua Huayuesc. Tổng giá trị $410,000 DDP. Thời gian giao: 32 ngày từ ký PO đến giao toàn bộ container 4×40HQ về kho dự án. Tiết kiệm $58,000 (~14%) so với phương án nhập qua phân phối Việt Nam. Developer nhận xét: 'Audit on-site CSR tại OPPEIN Quảng Châu giúp chúng tôi an tâm về chất lượng — chính chủ đầu tư cũng được mời sang xem dây chuyền sản xuất.'" },
      { type: "p", text: "Huayuesc dự báo OPPEIN sẽ duy trì vị thế top 1 châu Á thêm 5-7 năm nhờ R&D mạnh và automation đầu ngành. Buyer Việt Nam có dự án căn hộ 50+ căn nên cân nhắc OPPEIN trong shortlist sourcing." },
    ],
  },
  {
    ...
    content: [
      { type: "p", text: "Đặt sample là bảo hiểm tốt nhất cho buyer mới. Nhưng đội Customer Success Huayuesc thường xuyên gặp những trường hợp sample 'đẹp như mơ' nhưng MOQ về lại 'kém như mong đợi'. Phân tích 5 sai lầm phổ biến nhất và cách khắc phục." },
      ...
      { type: "p", text: "Huayuesc khuyến nghị buyer quay video unboxing sample (5-10 phút) — chứng cứ về tình trạng nhận, packaging, label, sản phẩm. Khi có dispute, video này gấp 10x giá trị so với photo. Huayuesc cũng quay video kiểm hàng tại Quảng Châu — buyer so sánh 2 video để verify NCC ship đúng spec." },
  ...
  },
  {
    ...
    title: "Vietnam Expo 2026 — Đoàn Huayuesc dẫn 30 buyer",
    excerpt: "09/04 - 12/04 tại Trung tâm Triển lãm Quốc tế Hà Nội. Đoàn Huayuesc tổ chức B2B match-making với 50+ NCC Trung Quốc đến VN. Đăng ký miễn phí cho buyer.",
    category: "hoi-cho",
    ...
    content: [
      { type: "p", text: "Vietnam Expo 2026 — sự kiện thương mại quốc tế lớn nhất Việt Nam — sẽ diễn ra từ 09/04 đến 12/04/2026 tại Trung tâm Triển lãm Quốc tế Hà Nội (148 Giảng Võ). Huayuesc sẽ có booth hall A2-15 và tổ chức chương trình B2B match-making cho 30 buyer Việt Nam gặp 50+ NCC Trung Quốc đến VN." },
      { type: "h2", text: "Vì sao Vietnam Expo quan trọng?" },
      { type: "p", text: "Đây là dịp duy nhất trong năm khi NCC top tier Trung Quốc đến tận Hà Nội — buyer không cần bay sang TQ. Năm 2026 có 50+ NCC từ Huayuesc ecosystem (Foshan, Quảng Châu, Thâm Quyến, Hàng Châu) tham dự, mang theo sample mẫu mới và sẵn sàng đàm phán MOQ trực tiếp." },
      { type: "h2", text: "Chương trình của booth Huayuesc" },
      { type: "list", items: [
        ...
        "Networking dinner: 11/04, 19h tại JW Marriott — 100 buyer + 50 NCC + đại diện Huayuesc.",
      ]},
      { type: "img", src: u("1505373877841-8d25f7d46678", 1200, 500), caption: "Vietnam Expo Hà Nội 2025 — booth Huayuesc thu hút 800+ buyer trong 4 ngày" },
      { type: "h2", text: "30 suất đoàn miễn phí" },
      { type: "p", text: "Huayuesc tài trợ 30 suất đoàn miễn phí cho buyer Việt Nam, mỗi suất bao gồm: vé tham dự VIP (giá thị trường 500K), lịch B2B match-making 1-on-1 với 5-8 NCC theo ngành quan tâm, phiên dịch tiếng Trung 1 buyer-1 phiên dịch trong các cuộc gặp, networking dinner 11/04 (giá thị trường 1.5tr), follow-up support 30 ngày sau Expo." },
      { type: "h2", text: "Đăng ký" },
      { type: "p", text: "Đăng ký qua /buying-request với note 'Vietnam Expo 2026' hoặc email events@huayuesc.vn. Ưu tiên buyer có doanh thu ≥10 tỷ/năm và đang sourcing đơn ≥$20K. Deadline: 25/03/2026 hoặc khi đủ 30 suất." },
      { type: "quote", text: "Vietnam Expo là sân nhà của buyer Việt Nam. Chúng tôi mời NCC đến tận VN thay vì buyer phải bay sang TQ — tiết kiệm visa, vé, thời gian.", author: "Đội Marketing Huayuesc" },
    ],
  },
  {
    ...
    content: [
      { type: "p", text: "Hầu hết product pages trên Huayuesc có pricing tier với 4 mức MOQ: 1-49, 50-99, 100-499, 500+. Buyer mới thường thấy 'mức 500 rẻ hơn 22% — tiết kiệm 22% chắc chắn nên đặt 500'. Nhưng quyết định không đơn giản như vậy." },
      ...
      { type: "p", text: "Huayuesc thường giúp 2-3 buyer cùng ngành combine đơn để đạt MOQ 500 hưởng giá tốt nhưng mỗi buyer chỉ lấy 100-200. Ví dụ: 2 showroom HN + 1 showroom Hải Phòng cùng đặt sofa, mỗi bên 150-200 cái → tổng 500 → giá tier 4. Lợi ích chia đều, rủi ro inventory thấp. Liên hệ Quản lý tài khoản CSR để arrange." },
  ...
  },
  {
    ...
    excerpt: "Cảnh báo Thương mại là email newsletter miễn phí của Huayuesc gửi mỗi thứ 5 với xu hướng giá, sản phẩm mới, deal limited. Đã có 12,000+ buyer subscribe.",
    category: "san-pham-moi",
    ...
    content: [
      { type: "p", text: "Huayuesc ra mắt Cảnh báo Thương mại năm 2023 và đã có 12,000+ buyer Việt Nam đăng ký nhận newsletter hàng tuần. Đây là kênh email miễn phí giúp buyer cập nhật xu hướng ngành sourcing mà không cần chủ động tìm kiếm." },
      ...
      { type: "p", text: "Mỗi thứ 5, 14h00 (giờ Hà Nội). Email từ trade-alert@huayuesc.vn, subject 'Cảnh báo Thương mại #XXX — [highlight tuần]'. Read time 5-7 phút, mobile-optimized HTML email với ảnh và link CTA." },
      { type: "h2", text: "Đăng ký" },
      ...
      { type: "p", text: "Cảnh báo Thương mại là một phần của tinh thần Huayuesc: chia sẻ tri thức tự do giữa các thương nhân số. Buyer mới và lâu năm đều có thể học hỏi, đỡ bỏ lỡ cơ hội thị trường." },
    ],
  },
];
