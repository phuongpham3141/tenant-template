...
export const ARTICLES: BlogArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Đăng ký qua /buying-request với note 'Vietnam Expo 2026' hoặc email mcy@huayuesc.com. Ưu tiên buyer có doanh thu ≥10 tỷ/năm và đang sourcing đơn ≥$20K. Deadline: 25/03/2026 hoặc khi đủ 30 suất." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Mỗi thứ 5, 14h00 (giờ Hà Nội). Email từ mcy@huayuesc.com, subject 'Cảnh báo Thương mại #XXX — [highlight tuần]'. Read time 5-7 phút, mobile-optimized HTML email với ảnh và link CTA." },
      { type: "h2", text: "Đăng ký" },
