...
const TOPICS: Record<string, Topic> = {
  "about-us": {
    title: "Huayuesc 华越供应链 — Chuỗi cung ứng Trung-Việt cho VLXD, Nội thất & Đồ điện gia dụng",
    intro:
      "Huayuesc (华越供应链) là nhà cung cấp dịch vụ chuỗi cung ứng toàn diện, chuyên xuất khẩu vật liệu xây dựng, vật liệu trang trí và thiết bị điện gia dụng nhà bếp – phòng tắm chất lượng cao từ Trung Quốc vào thị trường Việt Nam. Chúng tôi tích hợp từ khâu thu mua, kho bãi, logistics, thông quan, phân phối đến tiếp thị bản địa hóa — đưa đến khách hàng chuỗi cung ứng trọn gói từ nhà máy Trung Quốc đến điểm tiêu thụ cuối cùng tại Việt Nam.",
    icon: "🌏",
    category: "VỀ HUAYUE",
    quickFacts: [
      { label: "Tên pháp lý", value: "Công ty TNHH Chuỗi Cung Ứng Huayue Việt Nam" },
      { label: "Mã số thuế", value: "0111453693" },
      { label: "Trụ sở Việt Nam", value: "KCN Nam Đình Vũ, cảng Hải Phòng" },
    ...
    paragraphs: [
      "Tầm nhìn của Huayuesc là trở thành công ty kiểu mẫu về dịch vụ chuỗi cung ứng Trung Quốc – Việt Nam, dẫn dắt và kiến tạo nền sinh thái mới cho thương mại vật liệu xây dựng, đồ nội thất và đồ điện gia dụng giữa hai quốc gia (成为中越供应链服务的标杆企业, 引领中越建材家居贸易新生态). Chúng tôi mở ra con đường thương mại mới — đưa sản phẩm Trung Quốc chất lượng cao từ các cụm nhà máy hàng đầu Quảng Đông, Phúc Kiến, Sơn Đông trực tiếp đến tay nhà đầu tư bất động sản, công ty xây dựng, công ty thiết kế trang trí nội thất và đại lý phân phối tại Việt Nam. Khách hàng không cần qua trung gian, không cần phải bay sang Trung Quốc; mọi khâu từ chọn nhà máy đến giao hàng tận kho đều do Huayuesc đảm nhiệm.",
      "Huayuesc cung cấp chuỗi cung ứng trọn gói gồm bốn dịch vụ trọng tâm. (1) Tinh chọn nguồn gốc và hỗ trợ thu mua (源头精选与采购支持) — chúng tôi giúp khách hàng sàng lọc nhà cung cấp Trung Quốc có sức cạnh tranh, kiểm soát chất lượng tại xưởng, quản lý đơn hàng và thu mua tập trung để giảm thiểu giá thành lẫn rủi ro. (2) Kho bãi tại Trung Quốc và tập trung vận chuyển (中国境内仓储与集运) — chúng tôi xây dựng hoặc hợp tác với các kho hiện đại đặt tại các khu công nghiệp và bến cảng chủ chốt, cung cấp dịch vụ quản lý kho chứa an toàn và hiệu quả. (3) Vận chuyển xuyên biên giới và thông quan hiệu quả (跨境物流与高效清关) — cung cấp nhiều loại hình vận chuyển door-to-door và port-to-port; tại Việt Nam, đội ngũ thông quan của Huayuesc tại cảng Hải Phòng am hiểu luật xuất nhập khẩu, đảm bảo thông quan nhanh chóng, đúng pháp luật và tiết kiệm chi phí. (4) Phát triển kênh phân phối Việt Nam (本地化分销渠道拓展) — dựa vào hệ thống đối tác rộng lớn tại Việt Nam, chúng tôi đưa thương hiệu và sản phẩm Trung Quốc thâm nhập các kênh phân phối chính tại Hà Nội, Hồ Chí Minh và các tỉnh trọng điểm.",
      "Sản phẩm Trung Quốc có ưu thế rõ rệt về giá thành cạnh tranh, chủng loại phong phú, dây chuyền sản xuất thành thạo và tốc độ đổi mới nhanh (性价比高、品类丰富、产业链成熟、创新速度快). Huayuesc tập trung vào ba lĩnh vực chính. (i) Vật liệu xây dựng (建材) — gạch men sứ porcelain, thiết bị vệ sinh sanitaryware, kim khí ngũ kim, vật liệu cửa và profile nhôm/PVC, sơn và lớp phủ, ống nước cùng phụ kiện đường ống, thiết bị chiếu sáng. (ii) Vật liệu trang trí nội thất (装饰材料) — giấy dán tường và vải dán tường, sàn gỗ công nghiệp/sàn gỗ tự nhiên, vật liệu trang trí trần, đá tự nhiên và đá nhân tạo, đồ trang trí nội thất gia đình. (iii) Đồ điện nhà bếp và phòng tắm (厨卫小家电) — bình nóng lạnh điện, bếp gas, máy hút mùi, nồi cơm điện, máy ép phá tế bào, nắp bồn cầu thông minh cùng các thiết bị nhà tắm tiện ích khác. Mỗi danh mục đều có ít nhất 20 nhà máy đối tác đã được chúng tôi audit thực địa và đưa vào danh sách trắng.",
      "Hạ tầng kho bãi của Huayuesc lấy 'kho bảo thuế' (保税存储) làm trọng tâm, vận hành toàn bộ chu trình 'nhập kho – lưu trữ – xuất kho – thông quan' theo hướng tự động hóa và dữ liệu hóa. Chúng tôi vận hành ba loại kho chuyên dụng tại Trung Quốc: kho nhiệt độ thường cho hàng hóa phổ thông, kho riêng đạt chuẩn an toàn PCCC dành cho chất dễ cháy (sơn, chất pha loãng, dung môi), và kho nhiệt độ – độ ẩm ổn định dành cho thiết bị điện tử nhạy cảm. Mỗi kho được trang bị cửa dỡ hàng chuẩn container, bàn phân loại và đóng gói, cùng đối tác vận chuyển trực trú tại chỗ. Tại Việt Nam, đội ngũ thông quan của Huayuesc tích hợp trực tiếp với hệ thống hải quan tại cảng Hải Phòng — dữ liệu báo quan được truyền tải theo thời gian thực, quy trình khai báo tối giản, giảm đáng kể thời gian thông quan so với mô hình tự khai báo truyền thống.",
      "Huayuesc tổ chức dịch vụ triển lãm thương mại theo mô hình 'trưng bày thương hiệu theo bối cảnh + phục vụ chuyên nghiệp tổng hợp' (品牌场景化展示 + 专业服务配套) — tạo nên môi trường giao dịch tiện lợi nơi khách hàng có thể đặt hàng trực tiếp ngay tại showroom. Hằng năm, chúng tôi tổ chức hội nghị giới thiệu sản phẩm mới của các thương hiệu Trung Quốc, diễn đàn chuyên đề về vật liệu xây dựng thân thiện môi trường và kỹ thuật đồ điện gia dụng — thu hút nhà đầu tư bất động sản Việt Nam, các nhà thầu xây dựng, công ty thiết kế trang trí nội thất đến tham dự và đặt hàng tại chỗ. Song song, chúng tôi vận hành chiến dịch truyền thông bài bản trên các kênh online và offline tại Việt Nam, đưa thương hiệu Trung Quốc đến gần hơn với người mua bản địa và lan tỏa thông điệp cốt lõi: 'Đến với Huayue, bạn không cần đi Trung Quốc — vẫn mua được sản phẩm Trung Quốc ưu việt một cách nhanh chóng và tiện lợi' (无需赴华, 一站式采购中国优质商品).",
      "Toàn bộ chuỗi cung ứng của Huayuesc được số hóa và hiển thị minh bạch (全流程可视化) — khách hàng theo dõi đơn hàng xuyên suốt từ khâu nguyên vật liệu tại xưởng sản xuất đến tay người tiêu dùng cuối tại Việt Nam. Nền tảng tích hợp hệ thống chuỗi cung ứng dữ liệu hóa thông minh, hỗ trợ thông tin sản phẩm – thị trường, dịch vụ thanh toán và quy đổi ngoại tệ, cùng giải pháp tài chính chuỗi cung ứng (supply-chain finance). Ba trụ cột công nghệ vận hành đồng bộ: (a) Quyết sách dữ liệu hóa (数据驱动决策) — phân tích big data để dự báo nhu cầu thị trường và tối ưu kho chứa; (b) Tự động hóa thông minh (智能自动化) — thuật toán AI tự động xử lý đơn hàng, điều phối vận chuyển và tối ưu lộ trình logistics; (c) Mạng lưới hợp tác (协同网络) — nền tảng liên kết toàn bộ nhà cung cấp, nhà sản xuất, công ty vận chuyển và kênh bán lẻ cuối cùng. Kết quả: chi phí vận hành giảm, hiệu quả sử dụng vốn tăng, doanh thu kinh doanh của đối tác tăng trưởng bền vững.",
      "Sứ mệnh của Huayuesc là thông qua dịch vụ chuỗi cung ứng một trạm chuyên nghiệp, hiệu quả cao và đáng tin cậy, giúp ngành chế tạo Trung Quốc tỏa sáng tại Việt Nam, đồng thời giúp thị trường Việt Nam phát triển lên tầng cao mới (助力中国制造闪耀越南, 赋能越南市场升级发展). Chúng tôi là CÔNG TY TNHH CHUỖI CUNG ỨNG HUAYUE VIỆT NAM — mã số thuế 0111453693, trụ sở tại Khu công nghiệp Nam Đình Vũ – cảng Hải Phòng, kết nối trực tiếp với văn phòng Quảng Châu đặt tại Tầng 3, Tòa 1, cảng Shuyu Chuangxing, bến tàu phía Bắc, làng Hoàng Phố, đường Tân Cảng Đông (新港东路), quận Hải Châu, thành phố Quảng Châu. Liên hệ trực tiếp qua hotline +86 181-2225-6999 hoặc gửi yêu cầu báo giá trên huayuesc.vn để được đội ngũ tư vấn báo giá DDP tận kho Việt Nam trong 24 giờ.",
    ],
    pullQuote: {
      text: "无需赴华，一站式采购中国优质商品 — Đến với Huayue, bạn không cần đi Trung Quốc cũng mua được sản phẩm Trung Quốc ưu việt một cách nhanh chóng và tiện lợi.",
      author: "Huayuesc · 华越供应链",
    },
    checklist: [
      "🏭 Sàng lọc nhà cung cấp + kiểm soát chất lượng tại nguồn (源头精选)",
      "📦 Kho bảo thuế (保税仓) — 3 loại kho chuyên dụng tại khu CN và bến cảng",
      ...
      "📞 Hỗ trợ tiếng Việt + tiếng Trung 24/7 qua hotline +86 181-2225-6999",
    ],
    related: [
  ...
  "careers": {
    ...
    sectionTitles: [
      "1. Sứ mệnh — Huayuesc trong kỷ nguyên vươn mình của dân tộc",
    ...
    pullQuote: {
      ...
      author: "Phạm Phương — Founder & CEO Huayuesc",
    },
    checklist: [
    ...
    primaryCta: { label: "Gửi CV — cùng dệt con đường tơ lụa số", href: "mailto:hr@huayuesc.vn" },
  },
  "terms-of-service": {
    title: "Điều khoản sử dụng — Huayuesc",
    intro:
      "Đây là thoả thuận pháp lý ràng buộc giữa bạn và Huayuesc, vận hành bởi Beeagents.com — một pháp nhân đăng ký tại Việt Nam (mã số doanh nghiệp 0XXXXXXXXX). Vui lòng đọc kỹ trước khi sử dụng nền tảng. Bằng việc đăng ký tài khoản, gửi RFQ, hoặc bất kỳ giao dịch nào trên nền tảng, bạn xác nhận đã hiểu, chấp nhận và đồng ý chịu sự ràng buộc của toàn bộ điều khoản dưới đây.",
    icon: "📜",
    category: "PHÁP LÝ",
    quickFacts: [
    ...
    pullQuote: {
      text: "Điều khoản sử dụng không phải để bảo vệ chúng tôi khỏi bạn — mà để định nghĩa rõ ràng cách Huayuesc, Buyer và Supplier hợp tác công bằng. Sự minh bạch là nền tảng của niềm tin B2B.",
      author: "Lê Hoàng Quân — Legal Counsel Huayuesc",
    },
    checklist: [
  ...
  "privacy-policy": {
    ...
    quickFacts: [
      ...
      { label: "DPO", value: "privacy@huayuesc.vn" },
    ...
    paragraphs: [
      ...
      "Huayuesc vận hành xuyên biên giới Việt Nam – Trung Quốc, dữ liệu Buyer Việt Nam có thể được transfer sang server tại Quảng Châu để đội Quảng Châu hỗ trợ audit / kiểm hàng / xử lý dispute. Truyền dữ liệu xuyên biên giới được bảo vệ bởi 3 lớp: (i) Standard Contractual Clauses (SCCs) — hợp đồng giữa Beeagents.com (Việt Nam) và pháp nhân CSR China Sourcing Co., Ltd. (Quảng Châu, công ty con) tuân thủ template chuẩn của Bộ Tư pháp Việt Nam. (ii) Encryption-in-transit — tất cả traffic VN↔CN qua TLS 1.3, certificate pinning, không thể intercept. (iii) Đăng ký Truyền dữ liệu xuyên biên giới với Cục An toàn thông tin theo Điều 25 NĐ 13/2023 (đã hoàn tất tháng 02/2026, mã đăng ký TDXBG-2026-XXXX). Bạn có quyền yêu cầu CSR KHÔNG transfer dữ liệu sang Trung Quốc — chúng tôi sẽ tôn trọng nhưng có thể giới hạn dịch vụ audit on-site.",
      ...
      "Chính sách này được CSR review tối thiểu 1 lần/năm và cập nhật khi có thay đổi pháp luật, công nghệ hoặc dịch vụ. Phiên bản hiện tại là v3.2, hiệu lực 01/01/2026. Phiên bản cũ được archive tại /info/privacy-policy/lich-su để tham chiếu. Khi có thay đổi material (ảnh hưởng quyền lợi user), CSR thông báo qua: (a) Email tới mọi user đang hoạt động ít nhất 30 ngày trước khi áp dụng. (b) Banner hiển thị trên website/app trong 60 ngày. (c) Yêu cầu user re-consent nếu thay đổi mục đích xử lý dữ liệu. Liên hệ DPO (Data Protection Officer): Email privacy@huayuesc.vn (phản hồi <72h), điện thoại +84 24 1234 5678 (giờ hành chính), thư tay 'DPO — Huayuesc / Beeagents.com', Tầng 12, Tòa nhà Huayuesc, 26 Phạm Hùng, Cầu Giấy, Hà Nội. Cơ quan chức năng để khiếu nại độc lập: Cục An toàn thông tin (Bộ TT&TT), 18 Nguyễn Du, Hà Nội — website ais.gov.vn.",
    ],
    pullQuote: {
      text: "Bảo mật không phải checkbox — nó là một quá trình. Huayuesc invest 12% engineering effort vào security & privacy, với mục tiêu trở thành nền tảng B2B Việt Nam đầu tiên đạt chứng chỉ SOC 2 Type II vào Q4/2026.",
      author: "Đội An toàn thông tin Huayuesc",
    },
    checklist: [
      ...
      "DPO: privacy@huayuesc.vn — phản hồi <72 giờ",
    ],
    faq: [
      {
        q: "CSR có bán dữ liệu của tôi cho bên thứ ba không?",
        a: "TUYỆT ĐỐI KHÔNG. Mô hình kinh doanh của Huayuesc dựa vào 5% commission từ Supplier khi giao dịch thành công, KHÔNG dựa vào bán dữ liệu. Chúng tôi không chia sẻ dữ liệu với data broker, marketing aggregator, hay bất kỳ bên thứ ba nào không liên quan trực tiếp đến giao dịch của bạn.",
      },
      {
        q: "Tôi có thể yêu cầu xoá toàn bộ dữ liệu không?",
        a: "Có. Gửi email privacy@huayuesc.vn với subject 'Yêu cầu xoá dữ liệu — [tên/email tài khoản]'. Chúng tôi xác minh danh tính (qua OTP), thực hiện hard-delete trong 30 ngày, và gửi 'Certificate of Erasure' nếu yêu cầu. Lưu ý: chứng từ thuế (hoá đơn) phải được lưu 10 năm theo Luật Quản lý thuế VN — phần này không thể xoá.",
      },
      {
      ...
      {
        q: "Tôi nhận email lạ tự xưng là Huayuesc — làm sao xác minh?",
        a: "Email chính thức của CSR luôn từ domain @huayuesc.vn (KHÔNG phải @cybersilkroad.com hay tương tự lừa đảo). Email giao dịch từ no-reply@huayuesc.vn. Email từ DPO/Legal/HR có domain @huayuesc.vn. Nếu nghi ngờ, forward email đó tới security@huayuesc.vn để chúng tôi verify trong 4 giờ. Nguyên tắc vàng: CSR KHÔNG BAO GIỜ yêu cầu mật khẩu qua email/điện thoại.",
      },
    ],
    related: [
  ...
  "network": {
    ...
    paragraphs: [
      "Tầm nhìn của Huayuesc không phải là cạnh tranh với các nền tảng B2B toàn cầu — mà là kết nối các thị trường ASEAN với hệ sinh thái sản xuất Trung Quốc theo một cách mà các nền tảng global không làm được: thông qua quan hệ hiệp hội chính thức. Khu vực Đông Nam Á có quy mô GDP $3.6 nghìn tỷ USD (2025), tăng trưởng 5.1%/năm, và là đối tác thương mại lớn nhất của Trung Quốc kể từ 2020. Trong dòng chảy này, Việt Nam đang ở vị trí đặc biệt — vừa là cửa ngõ giữa ASEAN và Trung Quốc trên đất liền (qua Lạng Sơn, Móng Cái), vừa là nơi 5 trong 6 hành lang cáp quang biển của khu vực hội tụ. Huayuesc đặt mình vào chính giao điểm đó: thay vì xây 'đội audit Quảng Châu' kiểu thường, chúng tôi ký MOU với các hiệp hội ngành chính thức của cả 3 khối — Việt Nam, Trung Quốc, ASEAN — để tận dụng mạng lưới đã có sẵn của họ. Mô hình này linh hoạt hơn, có pháp lý rõ ràng hơn, và quan trọng nhất: tạo ra giá trị thực cho cả buyer và supplier mà chỉ một văn phòng đại diện đơn lẻ không thể có.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Liên hệ partnership@huayuesc.vn với thông tin: tên hiệp hội, số thành viên, ngành, mục tiêu hợp tác cụ thể. Đội Partnership của CSR review trong 7-10 ngày, schedule call 60 phút để discuss scope. Quy trình từ first contact → MOU ký thường 8-14 tuần. CSR cởi mở với mọi hiệp hội B2B chính thức — không có quota.",
      },
    ],
    related: [
  ...
  "audit-process": {
    ...
    pullQuote: {
      ...
      author: "Lead Auditor — Huayuesc Audit Team",
    },
    checklist: [
  ...
  "contact": {
    ...
    paragraphs: [
      "Tầng 12, Tòa nhà Huayuesc, 26 Phạm Hùng, Cầu Giấy, Hà Nội. Tel: +84 24 1234 5678. Email: hanoi@huayuesc.vn. Giờ làm việc: 8h00-18h00 thứ 2 - thứ 7. Đội Hà Nội phụ trách: tư vấn buyer Việt Nam, after-sales, tranh chấp, chứng từ hải quan VN. Tất cả nói tiếng Việt thuần. Có khu trưng bày sample miễn phí cho buyer ghé thăm.",
      "26/F, Tianhe Plaza, Tianhe District, Guangzhou, China. Tel: +86 20 1234 5678. WeChat: huayuesc_qc. Email: guangzhou@huayuesc.vn. Đội Quảng Châu phụ trách: audit nhà máy, kiểm hàng on-site, sourcing mới, đối tác NCC. Có 8 auditor full-time đi 30+ thành phố Trung Quốc. Buyer Việt Nam có thể yêu cầu video call trực tiếp với đội QC tại nhà máy.",
  ...
  "trade-assurance": {
    ...
    intro:
      "Cơ chế trung gian do Huayuesc vận hành cùng Vietcombank, BIDV và Bank of China — buyer thanh toán vào tài khoản trung gian, NCC chỉ nhận tiền sau khi hàng đã giao đúng chất lượng và đặc tả. Mỗi đồng buyer chuyển đi đều có lá chắn pháp lý.",
    icon: "🛡",
  ...
  "market-reports": {
    ...
    pullQuote: {
      ...
      author: "Chief Economist, Huayuesc Research",
    },
    checklist: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Có. Dùng thử miễn phí 14 ngày cho gói Pro — full quyền truy cập 3 ngành buyer chọn, không cần thẻ tín dụng, hết trial tự động chuyển về Free (không tự động charge). Đăng ký tại docs.huayuesc.vn/trial.",
      },
      {
        q: "Báo cáo có chia sẻ giá NCC cụ thể (theo tên) không?",
        a: "Không, vì lý do bảo mật và competition. Chúng tôi chỉ aggregate (ví dụ 'top 10 NCC Foshan furniture có giá MDF trung bình $X/CBM, range $Y-Z'). Nếu buyer muốn quote cụ thể từ NCC nào đó, vui lòng dùng RFQ trên Huayuesc — đó là kênh chính thức và minh bạch.",
      },
      {
        q: "Tôi đã subscribe rồi nhưng không nhận được Weekly Pulse?",
        a: "Email từ research@huayuesc.vn có thể vào Spam/Promotions. Khuyến nghị whitelist domain. Nếu vẫn không nhận, đăng nhập docs.huayuesc.vn/reports — mọi báo cáo đều xem được trên web kể cả khi email không tới. Liên hệ support@huayuesc.vn nếu issue lặp lại.",
      },
    ],
    related: [
  ...
  "api-integration": {
    ...
    intro:
      "86 REST endpoints + 24 webhook event + 4 SDK chính thức (Node · Python · PHP · Go) để doanh nghiệp tích hợp Huayuesc với ERP nội bộ (SAP, Oracle, Misa, Bravo, FAST), PIM, hoặc hệ thống quản lý 3PL. Đẩy SKU tự động, đồng bộ inventory, pull đơn về ERP, push tracking lên CSR — tất cả không nhập tay.",
    icon: "⚙️",
    ...
    faq: [
      {
        ...
        a: "SAP B1 và Oracle NetSuite connector đang trong roadmap Q2 2026, hiện chưa có zero-code option. Tuy nhiên Huayuesc SDK Node.js/Python/PHP có thể tích hợp tay với SAP DI Server (PHP/.NET) hoặc NetSuite SuiteScript trong 5-10 ngày-người. Tier Enterprise có dedicated solution architect hỗ trợ thiết kế integration miễn phí.",
      },
      {
        q: "Tài liệu API có bằng tiếng Việt không?",
        a: "Có. docs.huayuesc.vn/api hỗ trợ tiếng Việt và tiếng Anh, switch ở header. Code examples giữ nguyên tiếng Anh (theo convention dev quốc tế), nhưng giải thích, error message reference và best practices đều có bản tiếng Việt do đội Hà Nội biên dịch.",
      },
      {
        ...
        <article className="bg-paper border border-line rounded p-7 max-md:p-4">
          ...
          {t.checklist && t.checklist.length > 0 && (
            <div className="mt-7 bg-bg border-l-4 border-brand rounded-r p-5 max-md:p-3.5">
              <b className="block text-[14px] text-ink mb-3">✨ Cam kết của Huayuesc</b>
