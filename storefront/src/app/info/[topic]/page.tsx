...
const TOPICS: Record<string, Topic> = {
  "about-us": {
    ...
    quickFacts: [
      ...
      { label: "Trụ sở Việt Nam", value: "Toà nhà Ecolife, Đại Mỗ, Hà Nội" },
    ...
    checklist: [
      ...
      "📞 Hỗ trợ tiếng Việt + tiếng Trung 24/7 qua hotline",
    ],
    related: [
  ...
  "careers": {
    ...
    quickFacts: [
      ...
      { label: "Liên hệ HR", value: "mcy@huayuesc.com" },
    ],
    sectionTitles: [
    ...
    paragraphs: [
      ...
      "Quy trình ứng tuyển (4 bước, 2 tuần): (1) Gửi CV qua email <b>mcy@huayuesc.com</b> với tiêu đề '[Tên vị trí] - [Họ tên ứng viên] - [Văn phòng ứng tuyển: Hải Phòng hoặc Quảng Châu]'. Đính kèm CV tiếng Việt + tiếng Trung nếu ứng tuyển vị trí Quảng Châu. (2) HR phản hồi trong 3-5 ngày làm việc — cam kết 100% phản hồi, không ghosting. (3) Phỏng vấn trực tiếp/online với HR (30 phút) + trưởng bộ phận (60 phút) — sales test bằng roleplay với khách khó tính, broker test bằng case khai báo HS code, sourcing test bằng tình huống đàm phán giá với nhà máy. (4) Thử việc 1 tháng với mentor 1-1 — cuối kỳ đánh giá để chuyển chính thức. Offer trong 5-7 ngày kể từ buổi phỏng vấn cuối. Negotiate được — Huayue tôn trọng đối thoại lương minh bạch.",
      "Một ngày tại Huayue Quảng Châu (Sourcing Manager): 8:30 đến văn phòng Tầng 3 Cảng Shuyu Chuangxing, check email từ buyer Việt Nam đêm qua. 9:00 đi nhà máy gạch porcelain tại Phật Sơn (45 phút lái xe) cùng QC Inspector — kiểm chất lượng đơn hàng 500 m² của một đại lý Hà Nội. 12:00 ăn trưa với đại diện nhà máy, đàm phán giá đơn tiếp theo. 14:30 về văn phòng, viết PI tiếng Trung gửi nhà máy + bản dịch tiếng Việt gửi buyer. 16:00 video call với đội Hà Nội — đồng bộ trạng thái container đang trên đường. 17:30 xong việc. Một ngày tại Huayue Hà Nội (Customs Broker): 7:30 đến Toà nhà Ecolife, Đại Mỗ, Hà Nội, kiểm danh sách container về cảng hôm nay. 8:30 nhận chứng từ từ Quảng Châu (BL, Packing List, Invoice, C/O Form E). 9:00 khai báo VNACCS — tích hợp trực tiếp với hệ thống Tổng cục Hải quan, lệnh thông quan thường ra trong 2-4 giờ. 13:00 phối hợp đội kho dỡ container, inspection lô hàng. 15:00 bàn giao hàng cho xe đi giao tận kho khách tại HN/HCM. 17:30 về.",
    ],
    pullQuote: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Có. Chúng tôi nhận 4-6 thực tập sinh mỗi năm cho vị trí Sales/Marketing/Logistics tại Hải Phòng. Thời gian 3-6 tháng, lương 5-8 triệu VNĐ/tháng + cơ hội chuyển nhân viên chính thức nếu phù hợp. Recruit tháng 3 và tháng 9 hàng năm. Gửi CV qua mcy@huayuesc.com với tiêu đề bắt đầu '[Thực tập]'.",
      },
      {
  ...
  "terms-of-service": {
    ...
    paragraphs: [
      ...
      "Quyền của Buyer: (i) Truy cập miễn phí toàn bộ nền tảng — KHÔNG có phí thành viên, phí giao dịch hoặc commission. (ii) Gửi không giới hạn RFQ tới Supplier verified. (iii) Sử dụng dịch vụ Bảo đảm Giao dịch miễn phí cho mọi đơn ≥$100. (iv) Yêu cầu audit nhà máy on-site miễn phí cho đơn ≥$5,000 USD (đội Huayue tại Quảng Châu thực hiện). (v) Hỗ trợ Customer Success tiếng Việt qua hotline và email mcy@huayuesc.com. (vi) Quyền khiếu nại trong 7 ngày kể từ ngày nhận hàng. (vii) Quyền truy cập, sửa, xoá dữ liệu cá nhân theo NĐ 13/2023. Nghĩa vụ của Buyer: (a) Cung cấp thông tin chính xác khi đăng ký + giao dịch. (b) Tuân thủ pháp luật Việt Nam (đặc biệt: cấm nhập hàng giả, hàng cấm, hàng vi phạm sở hữu trí tuệ đã đăng ký tại VN). (c) Thanh toán đầy đủ, đúng hạn theo PI/PO đã ký. (d) Phản hồi yêu cầu xác nhận hàng trong 14 ngày kể từ ngày giao (sau đó hệ thống auto-release). (e) KHÔNG sử dụng nền tảng cho hoạt động bất hợp pháp (rửa tiền, trốn thuế, gian lận thương mại).",
      ...
      "Huayue thu thập, xử lý dữ liệu cá nhân theo Chính sách bảo mật chi tiết tại /info/privacy-policy — tuân thủ NĐ 13/2023/NĐ-CP, PIPL 2021 và GDPR khi áp dụng. Người dùng có 11 quyền cơ bản (xem, sửa, xoá, hạn chế xử lý, portability, etc.) — gửi yêu cầu tới mcy@huayuesc.com. Truyền dữ liệu xuyên biên giới VN–CN giữa trụ sở Hà Nội và văn phòng đại diện Quảng Châu được bảo vệ qua Standard Contractual Clauses (SCCs); Huayue đang trong quá trình hoàn tất đăng ký truyền dữ liệu xuyên biên giới với Cục An toàn thông tin theo Điều 25 NĐ 13/2023. Cookies: 4 nhóm (thiết yếu / phân tích / marketing / partner), banner consent với 3 lựa chọn. Huayue KHÔNG bán dữ liệu cho data broker. Lưu giữ chứng từ giao dịch 10 năm theo Luật Quản lý thuế VN. Khi Buyer đóng tài khoản: hard-delete trong 30 ngày + cấp Certificate of Erasure nếu yêu cầu.",
    ...
    checklist: [
      ...
      "Trụ sở chính: Toà nhà Ecolife, Đại Mỗ, Hà Nội · Văn phòng đại diện: Quảng Châu, Trung Quốc",
  ...
  "privacy-policy": {
    ...
    quickFacts: [
      ...
      { label: "DPO email", value: "mcy@huayuesc.com" },
      { label: "DPO hotline", value: "" },
    ],
    sectionTitles: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Có. Gửi email mcy@huayuesc.com với subject 'Yêu cầu xoá dữ liệu — [tên/email tài khoản]'. Huayue xác minh danh tính (qua OTP), thực hiện hard-delete trong 30 ngày, và gửi 'Certificate of Erasure' nếu yêu cầu. Lưu ý: chứng từ thuế (hoá đơn) phải được lưu 10 năm theo Luật Quản lý thuế VN — phần này không thể xoá.",
      },
      {
      ...
      },
      {
        ...
        a: "Email chính thức của Huayue luôn từ domain @huayuesc.vn. Email giao dịch từ mcy@huayuesc.com. Email từ DPO/HR có domain @huayuesc.vn. Nếu nghi ngờ, forward email đó tới mcy@huayuesc.com để chúng tôi verify trong 4 giờ. Nguyên tắc vàng: Huayue KHÔNG BAO GIỜ yêu cầu mật khẩu qua email/điện thoại.",
      },
    ],
    related: [
  ...
  "import-guide": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Phần lớn vật liệu xây dựng, nội thất, sanitary, đèn LED, điện gia dụng KHÔNG cần giấy phép. Cần giấy phép cho: thực phẩm chức năng, mỹ phẩm, thiết bị y tế, hoá chất, dược phẩm, sách, phương tiện. Huayuesc tư vấn cụ thể theo HS code trước khi đặt hàng. Buyer mới có thể email mcy@huayuesc.com để được tư vấn miễn phí.",
      },
      {
      ...
      },
      {
        ...
        a: "Có với Air Freight Express (DHL/FedEx) — 2-4 ngày Foshan → Hà Nội. Cước $8-15/kg (đắt gấp 5-7x sea freight). Phù hợp sample, hàng hotfix, hàng giá trị cao kích thước nhỏ. Min charge $100/đơn. Liên hệ mcy@huayuesc.com để booking.",
      },
      {
  ...
  "disputes": {
    ...
    intro: "Buyer có quyền khiếu nại trong 7 ngày kể từ ngày nhận hàng. Huayue giải quyết theo 3 cấp: Mediation nội bộ (đội Hà Nội + Quảng Châu) → Trọng tài VIAC → TAND Hà Nội. SLA: 6 giờ email, 1 giờ qua hotline.",
    icon: "⚖",
    category: "AN TOÀN GIAO DỊCH",
    quickFacts: [
    ...
    paragraphs: [
      "Cấp 1 — Mediation tại Huayue (miễn phí, 7-14 ngày): Buyer gửi khiếu nại qua dashboard hoặc mcy@huayuesc.com TRONG 7 NGÀY kể từ ngày nhận hàng, kèm chứng cứ (ảnh, video, biên bản nghiệm thu, số đơn). Đội Dispute Resolution của Huayue Hà Nội tiếp nhận trong 6 giờ, liên hệ buyer + nhà máy để xác minh. Đội Quảng Châu có thể visit nhà máy kiểm tra trực tiếp nếu cần (cho lỗi sản xuất). Quyết định trong 7 ngày làm việc với 4 phương án: (a) Hoàn 100% từ tài khoản tín thác nếu hàng sai mô tả nghiêm trọng. (b) Đổi hàng miễn phí — nhà máy sản xuất lại + free DDP về VN. (c) Bồi thường thoả thuận — giảm giá X% nếu lỗi nhỏ buyer chấp nhận giữ. (d) Credit cho đơn tiếp.",
    ...
    checklist: [
      "📞 Hotline — phản hồi <1 giờ",
      "✉ mcy@huayuesc.com — phản hồi <6 giờ",
    ...
    primaryCta: { label: "Gửi khiếu nại — mcy@huayuesc.com", href: "mailto:mcy@huayuesc.com" },
  },
  "sample-orders": {
  ...
  "find-products": {
    ...
    paragraphs: [
      ...
      "Cách 4 — Gọi sourcing manager: hotline. Đội Huayue tại văn phòng Quảng Châu trực tiếp tư vấn, gửi danh sách NCC đã audit, đặt mẫu, đàm phán giá thay bạn. Cách nhanh nhất cho đơn lớn (>$10K) hoặc sản phẩm cần tuỳ chỉnh OEM.",
    ],
    related: [
  ...
  "network": {
    ...
    quickFacts: [
      ...
      { label: "Liên hệ", value: "mcy@huayuesc.com" },
    ],
    sectionTitles: [
    ...
    paragraphs: [
      ...
      "Trade fair quan trọng Huayue tham gia hằng năm (đại diện hoặc đồng tổ chức đoàn): <b>Canton Fair</b> (Quảng Châu, tháng 4 + tháng 10) — hội chợ B2B lớn nhất Trung Quốc, Huayue có gian hàng đại diện và tổ chức đoàn buyer Việt Nam. <b>CIFF (China International Furniture Fair)</b> (Quảng Châu tháng 3, Thượng Hải tháng 9) — chuyên ngành nội thất, đối tác chính cho danh mục Nội thất. <b>Foshan Pottery Show</b> (Phật Sơn, tháng 4 và 10) — chuyên gạch porcelain và sanitary. <b>VIETBUILD</b> (HCM tháng 6, Hà Nội tháng 11) — hội chợ vật liệu xây dựng Việt Nam, Huayue mời các nhà máy TQ đến tham dự cùng với đoàn Hải Phòng. <b>Vietnam Expo</b> (Hà Nội tháng 4) — Huayue tham gia phần triển lãm sản phẩm Trung Quốc. Đăng ký tham gia đoàn buyer Huayue qua mcy@huayuesc.com hoặc hotline.",
    ],
    pullQuote: {
    ...
    checklist: [
      ...
      "📞 Liên hệ mcy@huayuesc.com",
    ],
    faq: [
      {
        q: "Tôi muốn trở thành đại lý phân phối của Huayue tại tỉnh tôi — quy trình thế nào?",
        a: "Gửi email mcy@huayuesc.com kèm: giấy phép kinh doanh, thông tin showroom/kho hiện có, ngành đang phân phối (VLXD / nội thất / điện máy), khu vực coverage. Đội Huayue Hà Nội liên hệ qua điện thoại trong 5 ngày làm việc, có thể đến thăm trực tiếp nếu cần. Sau khi xác minh, ký hợp đồng đại lý — không phí thành viên, chỉ chia commission theo doanh số.",
      },
      {
        q: "Tôi là nhà thầu xây dựng — Huayue hỗ trợ gì cho dự án của tôi?",
        a: "Huayue gửi báo giá DDP tận công trình cho danh mục VLXD và trang trí nội thất (gạch, sanitary, đá ốp lát, sơn, sàn gỗ). Hỗ trợ: (1) gửi sample miễn phí cho đơn ≥30 bộ, (2) giao hàng theo tiến độ thi công (chia làm nhiều đợt), (3) bảo hành theo nhà máy gốc + Huayue chịu trách nhiệm đổi trả nếu lỗi. Liên hệ mcy@huayuesc.com hoặc.",
      },
      {
        q: "Tôi là công ty thiết kế nội thất — có ưu đãi cho khách VIP của tôi không?",
        a: "Có. Huayue cung cấp gói partnership cho công ty thiết kế: (a) catalogue tiếng Việt cho nhãn hàng TQ, (b) sample wood/stone/fabric, (c) hỗ trợ visual 3D miễn phí cho khách hàng cao cấp của bạn (đơn ≥30 bộ), (d) chiết khấu ưu đãi cho dự án trọn gói. Liên hệ mcy@huayuesc.com.",
      },
      {
        q: "Tôi muốn đi thăm nhà máy Trung Quốc — Huayue có tổ chức đoàn không?",
        a: "Có. Huayue tổ chức đoàn buyer Việt Nam đi Canton Fair (tháng 4 và 10), CIFF Quảng Châu (tháng 3 và 9), Foshan Pottery Show (tháng 4 và 10). Mỗi đoàn 10-25 buyer, có phiên dịch chuyên ngành và đội sourcing Huayue Quảng Châu đón. Đặt lịch business matching với nhà máy trước chuyến đi. Liên hệ mcy@huayuesc.com để biết lịch và chi phí cụ thể.",
      },
      {
    ...
    primaryCta: { label: "Liên hệ mcy@huayuesc.com", href: "mailto:mcy@huayuesc.com" },
  },
  "audit-process": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Có. Huayue cung cấp 'Standalone Factory Audit' service cho buyer doanh nghiệp lớn muốn audit nhà máy tự tìm — chi phí $1,800-3,500 tuỳ ngành, deliverable trong 10-15 ngày, full report ký số. Phù hợp khi buyer đã có shortlist 5-10 nhà máy từ Canton Fair và cần lọc trước khi ký hợp đồng. Liên hệ mcy@huayuesc.com.",
      },
    ],
    related: [
      { label: "Mạng lưới đối tác", href: "/info/network" },
  ...
  "contact": {
    ...
    paragraphs: [
      "Tầng 12, Tòa nhà Huayuesc, 26 Phạm Hùng, Cầu Giấy, Hà Nội. Tel. Email: mcy@huayuesc.com. Giờ làm việc: 8h00-18h00 thứ 2 - thứ 7. Đội Hà Nội phụ trách: tư vấn buyer Việt Nam, after-sales, tranh chấp, chứng từ hải quan VN. Tất cả nói tiếng Việt thuần. Có khu trưng bày sample miễn phí cho buyer ghé thăm.",
      "26/F, Tianhe Plaza, Tianhe District, Guangzhou, China. Tel. WeChat: huayuesc_qc. Email: mcy@huayuesc.com. Đội Quảng Châu phụ trách: audit nhà máy, kiểm hàng on-site, sourcing mới, đối tác NCC. Có 8 auditor full-time đi 30+ thành phố Trung Quốc. Buyer Việt Nam có thể yêu cầu video call trực tiếp với đội QC tại nhà máy.",
      "Hỗ trợ tức thì qua nhiều kênh: Email mcy@huayuesc.com (phản hồi <6 giờ), Live chat trên website (5 phút), Zalo OA: Huayuesc (chat tiếng Việt 24/7), Facebook Messenger: fb.com/huayuesc. Đội support 12 người chia 3 ca, đảm bảo có người phản hồi cả ngoài giờ hành chính, kể cả ngày nghỉ lễ.",
    ],
    checklist: [
      "Sales / Tư vấn sourcing: mcy@huayuesc.com",
      "Bảo đảm Giao dịch / Tranh chấp: mcy@huayuesc.com",
      "Tuyển dụng: mcy@huayuesc.com",
      "Báo chí / PR: mcy@huayuesc.com",
      "DPO bảo mật: mcy@huayuesc.com",
    ],
    related: [
  ...
  "shipping-policy": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Có, dành cho Buyer enterprise ≥$100K/năm. Liên hệ mcy@huayuesc.com để được cấp API key + webhook URL. Documentation tại docs.huayuesc.vn/api/tracking. Free tier 1000 requests/ngày, Pro $99/tháng cho unlimited.",
      },
      {
  ...
  "market-reports": {
    ...
    paragraphs: [
      ...
      "Cách truy cập báo cáo: Báo cáo Market Intelligence của Huayue là <b>miễn phí cho mọi buyer đang mua hàng từ Huayue</b> (giá trị bổ sung của partnership). Đăng nhập tài khoản tại huayuesc.vn → Buyer Center → Tab 'Market Reports'. Đối tác phân phối ký hợp đồng partnership được nhận báo cáo + bản phân tích cho khu vực kinh doanh của mình. Khách hàng tiềm năng (chưa giao dịch): xem được Weekly Pulse (4-6 trang/tuần, free). Liên hệ mcy@huayuesc.com hoặc mcy@huayuesc.com để nhận sample báo cáo gần nhất.",
    ],
    pullQuote: {
    ...
    faq: [
      {
        ...
        a: "Hiện tại Huayue chỉ xuất bản tiếng Việt và tiếng Trung. Buyer cần bản tiếng Anh cho đối tác/đầu tư nước ngoài có thể gửi email mcy@huayuesc.com để yêu cầu — đội Research dịch bằng tay cho yêu cầu cụ thể.",
      },
      {
      ...
      },
      {
        ...
        a: "Email từ mcy@huayuesc.com có thể vào Spam/Promotions. Whitelist domain. Nếu vẫn không nhận, liên hệ mcy@huayuesc.com — chúng tôi gửi lại link đăng nhập để bạn xem trên web.",
      },
    ],
    related: [
  ...
  "api-integration": {
    ...
    intro:
      "Huayue đang phát triển REST API + Webhook để buyer doanh nghiệp lớn tích hợp đơn hàng Huayue trực tiếp vào ERP nội bộ (Misa, Bravo, FAST, SAP B1, Oracle NetSuite) — đẩy đơn về kế toán, đồng bộ kho, issue hoá đơn điện tử theo NĐ 123/2020. Dự kiến ra mắt phiên bản đầu Q4 2026. Đăng ký early access miễn phí 6 tháng tại mcy@huayuesc.com.",
    icon: "⚙️",
    ...
    quickFacts: [
      ...
      { label: "Đăng ký sớm", value: "mcy@huayuesc.com" },
    ],
    sectionTitles: [
    ...
    checklist: [
      ...
      "📥 Đăng ký early access miễn phí 6 tháng: mcy@huayuesc.com",
    ...
    faq: [
      {
        ...
        a: "Connector cho Misa SME, Bravo, FAST Accounting nằm trong wave đầu tiên của API release Q4 2026. Hiện tại nếu khẩn cấp, đội kỹ thuật Huayue có thể export đơn hàng ra Excel/CSV theo lịch tuỳ chỉnh (hàng ngày/tuần) gửi qua email — bạn import thủ công vào ERP. Gửi yêu cầu qua mcy@huayuesc.com.",
      },
      {
    ...
    primaryCta: { label: "Đăng ký nhận thông báo khi API ra mắt", href: "mailto:mcy@huayuesc.com?subject=API%20Integration%20Interest" },
  },
  "locale": {
