...
const TOPICS: Record<string, Topic> = {
  ...
  "terms-of-service": {
    ...
    checklist: [
      "Chủ quản VGEA — vận hành qua công ty quản lý do VGEA chỉ định: [TÊN CÔNG TY QUẢN LÝ] (MST [MST])",
  ...
  "privacy-policy": {
    ...
    paragraphs: [
      ...
      "Cybersilkroads vận hành xuyên biên giới Việt Nam – Trung Quốc, dữ liệu Buyer Việt Nam có thể được transfer sang server tại Quảng Châu để đội Quảng Châu hỗ trợ audit / kiểm hàng / xử lý dispute. Truyền dữ liệu xuyên biên giới được bảo vệ bởi 3 lớp: (i) Standard Contractual Clauses (SCCs) — hợp đồng giữa [TÊN CÔNG TY QUẢN LÝ] (Việt Nam) và pháp nhân CSR China Sourcing Co., Ltd. (Quảng Châu, công ty con) tuân thủ template chuẩn của Bộ Tư pháp Việt Nam. (ii) Encryption-in-transit — tất cả traffic VN↔CN qua TLS 1.3, certificate pinning, không thể intercept. (iii) Đăng ký Truyền dữ liệu xuyên biên giới với Cục An toàn thông tin theo Điều 25 NĐ 13/2023 (đã hoàn tất tháng 02/2026, mã đăng ký TDXBG-2026-XXXX). Bạn có quyền yêu cầu CSR KHÔNG transfer dữ liệu sang Trung Quốc — chúng tôi sẽ tôn trọng nhưng có thể giới hạn dịch vụ audit on-site.",
