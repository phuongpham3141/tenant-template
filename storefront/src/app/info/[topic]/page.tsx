...
const TOPICS: Record<string, Topic> = {
  "about-us": {
    ...
    paragraphs: [
      ...
      "Sứ mệnh của Huayuesc là thông qua dịch vụ chuỗi cung ứng một trạm chuyên nghiệp, hiệu quả cao và đáng tin cậy, giúp ngành chế tạo Trung Quốc tỏa sáng tại Việt Nam, đồng thời giúp thị trường Việt Nam phát triển lên tầng cao mới (助力中国制造闪耀越南, 赋能越南市场升级发展). Chúng tôi là CÔNG TY TNHH CHUỖI CUNG ỨNG HUAYUE VIỆT NAM — mã số thuế 0111453693, trụ sở chính tại Toà Bảo Ngọc Building, số 02 phố Thanh Lâm, Phường Xuân Phương, Hà Nội, kết nối trực tiếp với văn phòng Quảng Châu đặt tại Tầng 3, Tòa 1, cảng Shuyu Chuangxing, bến tàu phía Bắc, làng Hoàng Phố, đường Tân Cảng Đông (新港东路), quận Hải Châu, thành phố Quảng Châu. Liên hệ trực tiếp qua hotline +86 181-2225-6999 hoặc gửi yêu cầu báo giá trên huayuesc.vn để được đội ngũ tư vấn báo giá DDP tận kho Việt Nam trong 24 giờ.",
    ],
    pullQuote: {
  ...
  "disputes": {
    ...
    intro: "Buyer có quyền khiếu nại trong 7 ngày kể từ ngày nhận hàng. Huayue giải quyết theo 3 cấp: Mediation nội bộ (đội Hà Nội + Quảng Châu) → Trọng tài VIAC → TAND Hà Nội. SLA: 6 giờ email, 1 giờ qua hotline +86 181-2225-6999.",
    icon: "⚖",
    category: "AN TOÀN GIAO DỊCH",
    quickFacts: [
