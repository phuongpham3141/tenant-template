...
const TOPICS: Record<string, Topic> = {
  "about-us": {
    ...
    sectionTitles: [
      ...
      "Kết nối nhà máy Trung Quốc ↔ đại lý & cửa hàng Việt Nam",
    ],
    paragraphs: [
      ...
      "Trung tâm của Cybersilkroads là trí tuệ con người Việt Nam — những người 'dệt' nên con đường bằng từng dòng lệnh và sự sáng tạo. Mục tiêu cuối cùng: xây dựng một không gian mạng hòa bình, thịnh vượng, nơi Việt Nam đóng vai trò nhịp cầu kết nối các nền văn minh số. Trên thực tế, Cybersilkroads triển khai dưới dạng nền tảng B2B kết nối thương nhân Việt Nam với hệ sinh thái sản xuất khu vực — thương mại có ý nghĩa, có chiều sâu văn hóa, không chỉ là giao dịch.",
      "Sứ mệnh thực tiễn của chúng tôi: kết nối trực tiếp nhà máy và doanh nghiệp vừa và nhỏ (SME) Trung Quốc với mạng lưới đại lý và cửa hàng bán lẻ Việt Nam — rút ngắn last-mile, đưa hàng tới tận tay nhà bán lẻ với giá gốc nhà máy, loại bỏ các tầng trung gian truyền thống. cybersilkroads.com là Sàn B2B trung tâm của Hiệp hội Thương mại Điện tử Toàn cầu Việt Nam (VGEA), hoạt động dưới sự chủ quản của VGEA và được vận hành qua công ty quản lý do VGEA chỉ định: Công ty Cổ phần Quốc tế Cyncahome (MST 0111355625).",
    ],
    pullQuote: {
  ...
  "terms-of-service": {
    ...
    intro:
      "Đây là thoả thuận pháp lý ràng buộc giữa bạn và Cybersilkroads (CSR) — Sàn B2B trung tâm của Hiệp hội Thương mại Điện tử Toàn cầu Việt Nam (VGEA), được vận hành qua công ty quản lý do VGEA chỉ định: Công ty Cổ phần Quốc tế Cyncahome (MST 0111355625). Vui lòng đọc kỹ trước khi sử dụng nền tảng. Bằng việc đăng ký tài khoản, gửi RFQ, hoặc bất kỳ giao dịch nào trên nền tảng, bạn xác nhận đã hiểu, chấp nhận và đồng ý chịu sự ràng buộc của toàn bộ điều khoản dưới đây.",
    icon: "📜",
    category: "PHÁP LÝ",
    quickFacts: [
    ...
    sectionTitles: [
      ...
      "6b. Nhập khẩu Ủy thác qua công ty do VGEA chỉ định",
    ...
    paragraphs: [
      ...
      "Quyền của Supplier: (i) Hiển thị sản phẩm + nhận RFQ từ Buyer Việt Nam. (ii) Mô hình phí dịch vụ minh bạch theo kết quả — chỉ thu 2% trên giá trị đơn hàng phát sinh theo 'Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam' (chia sẻ doanh thu theo kết quả), khách hàng được CSR giới thiệu được bảo hộ 5 năm. (iii) Quyền pre-screen Buyer — từ chối đơn không phù hợp capability. (iv) Hỗ trợ marketing tại Việt Nam (landing page tiếng Việt, dịch catalogue). (v) Báo cáo audit blockchain-signed có giá trị marketing. Nghĩa vụ của Supplier: (a) Pass quy trình audit 5 bước trước khi go-live. (b) Cập nhật giá + MOQ + thời gian giao chính xác. (c) Phản hồi RFQ trong 24 giờ. (d) Sản xuất + giao hàng đúng PO đã ký, không thay đổi spec không thông báo. (e) Hợp tác với QC inspector của CSR trước xuất xưởng. (f) Không bypass nền tảng (cấm liên hệ Buyer ngoài CSR để né phí dịch vụ — vi phạm bị banned vĩnh viễn + phạt 8% giá trị đơn theo điều khoản chống né phí của Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam).",
      "Mọi giao dịch ≥$100 USD trên CSR được bảo vệ bởi Bảo đảm Giao dịch (Trung gian) — đây là điểm khác biệt cốt lõi của nền tảng. Cơ chế: (1) Buyer thanh toán T/T 30% deposit + 70% balance vào tài khoản trung gian của CSR tại ngân hàng đối tác (Vietcombank cho VND, Bank of China + HSBC cho USD). (2) Tiền KHÔNG được release cho Supplier cho đến khi: Buyer xác nhận hàng đúng mô tả qua dashboard, HOẶC 14 ngày kể từ ngày giao mà Buyer không phản hồi (auto-release), HOẶC dispute được giải quyết theo Mục 7. (3) Phí dịch vụ: CSR thu phí dịch vụ 2% trên giá trị đơn hàng phát sinh từ Supplier theo 'Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam' (chia sẻ doanh thu theo kết quả) — KHÔNG thu Buyer. (4) Phương thức thanh toán hỗ trợ: T/T (telegraphic transfer), Letter of Credit (L/C — cho đơn ≥$100K), Online Banking quốc tế qua Wise/Payoneer (cho đơn nhỏ <$5K). (5) Tỷ giá: theo Vietcombank realtime, có buffer 0.5% phòng biến động. (6) Phí ngân hàng: Buyer trả phí chuyển tiền đi (~0.1-0.3%), Supplier trả phí nhận tiền về.",
      ...
      "Mô hình Nhập khẩu Ủy thác: với Buyer chưa có pháp nhân nhập khẩu hoặc muốn được lo trọn gói pháp lý, CSR hỗ trợ ký hợp đồng phân phối qua Công ty Thương mại ủy thác do VGEA chỉ định. Công ty ủy thác này đứng tên nhập khẩu chính ngạch, lo toàn bộ thủ tục hợp chuẩn/hợp quy theo từng ngành hàng: Mỹ phẩm/Thực phẩm cần công bố mỹ phẩm/ATVSTP; Vật liệu xây dựng/Hóa chất cần công bố hợp quy + dấu CR + khai báo hóa chất; Thiết bị điện/Đồ gia dụng cần dán nhãn năng lượng. Buyer ký hợp đồng phân phối với công ty ủy thác, nhận hàng đã thông quan hợp pháp kèm đầy đủ hồ sơ công bố/hợp quy — không phải tự lo giấy phép nhập khẩu hay thủ tục công bố. Chi phí ủy thác minh bạch theo thoả thuận trong hợp đồng phân phối.",
    ...
    checklist: [
      "Chủ quản VGEA — vận hành qua công ty quản lý do VGEA chỉ định: Công ty Cổ phần Quốc tế Cyncahome (MST 0111355625)",
    ...
    faq: [
      ...
      {
        q: "CSR có thể đổi mức phí dịch vụ đột ngột không?",
        a: "Không. Thay đổi mức phí dịch vụ (hiện 2% trên giá trị đơn hàng phát sinh theo Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam) là thay đổi material ảnh hưởng quyền lợi của Supplier — phải thông báo 30 ngày trước + có quyền opt-out (đóng tài khoản trước ngày hiệu lực, không bị penalty).",
      },
    ],
    related: [
  ...
  "privacy-policy": {
    ...
    paragraphs: [
      ...
      "Cybersilkroads vận hành xuyên biên giới Việt Nam – Trung Quốc, dữ liệu Buyer Việt Nam có thể được transfer sang server tại Quảng Châu để đội Quảng Châu hỗ trợ audit / kiểm hàng / xử lý dispute. Truyền dữ liệu xuyên biên giới được bảo vệ bởi 3 lớp: (i) Standard Contractual Clauses (SCCs) — hợp đồng giữa Công ty Cổ phần Quốc tế Cyncahome (Việt Nam) và pháp nhân CSR China Sourcing Co., Ltd. (Quảng Châu, công ty con) tuân thủ template chuẩn của Bộ Tư pháp Việt Nam. (ii) Encryption-in-transit — tất cả traffic VN↔CN qua TLS 1.3, certificate pinning, không thể intercept. (iii) Đăng ký Truyền dữ liệu xuyên biên giới với Cục An toàn thông tin theo Điều 25 NĐ 13/2023 (đã hoàn tất tháng 02/2026, mã đăng ký TDXBG-2026-XXXX). Bạn có quyền yêu cầu CSR KHÔNG transfer dữ liệu sang Trung Quốc — chúng tôi sẽ tôn trọng nhưng có thể giới hạn dịch vụ audit on-site.",
    ...
    faq: [
      {
        ...
        a: "TUYỆT ĐỐI KHÔNG. Mô hình kinh doanh của Cybersilkroads dựa vào phí dịch vụ 2% từ nhà cung cấp khi giao dịch thành công, KHÔNG dựa vào bán dữ liệu. Chúng tôi không chia sẻ dữ liệu với data broker, marketing aggregator, hay bất kỳ bên thứ ba nào không liên quan trực tiếp đến giao dịch của bạn.",
      },
      {
  ...
  "import-guide": {
    ...
    sectionTitles: [
      ...
      "Nhập khẩu Ủy thác qua công ty do VGEA chỉ định",
      "Bảng compliance hợp chuẩn/hợp quy theo ngành",
    ],
    paragraphs: [
      ...
      "Ví dụ tính thuế thực tế cho đơn nội thất gỗ HS 9403.50 từ KUKA Hangzhou, giá trị $20,000 FOB, vận chuyển CIF Lạch Huyện, Buyer Hà Nội: (a) Giá FOB Foshan: $20,000. (b) Cước biển + bảo hiểm CIF: $4,000 → CIF $24,000. (c) Thuế nhập khẩu MFN HS 9403.50: 20% (sau Thông tư 12/2026 giảm từ 25%) → $4,800. Nếu có Form E ACFTA: 0% (miễn thuế!) → tiết kiệm $4,800. (d) VAT 10% × (CIF + Thuế NK) = 10% × $28,800 = $2,880 (nếu không Form E) hoặc 10% × $24,000 = $2,400 (nếu có Form E). (e) Phí thông quan: $120. (f) Vận chuyển nội địa Hải Phòng → kho HN: $280. (g) Phí dịch vụ CSR (2% trên giá trị đơn hàng phát sinh theo Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam, do NCC trả, KHÔNG tính Buyer): $0. TỔNG DDP nếu KHÔNG Form E: $20,000 + $4,000 + $4,800 + $2,880 + $120 + $280 = $32,080. TỔNG DDP NẾU CÓ Form E: $20,000 + $4,000 + $0 + $2,400 + $120 + $280 = $26,800. Tiết kiệm: $5,280 = 16.5%.",
      ...
      "Nhập khẩu Ủy thác qua công ty do VGEA chỉ định — dành cho Buyer chưa có pháp nhân nhập khẩu, hoặc muốn được lo trọn gói pháp lý thay vì tự đứng tên tờ khai. Với mô hình này, hợp đồng phân phối được ký qua Công ty Thương mại ủy thác do VGEA chỉ định: công ty đứng tên nhập khẩu chính ngạch, lo toàn bộ thủ tục hợp chuẩn/hợp quy theo từng ngành hàng, và giao hàng đã thông quan hợp pháp kèm đầy đủ hồ sơ công bố/hợp quy về kho Buyer. Mô hình này chạy song song với toàn bộ quy trình DDP và ưu đãi thuế ACFTA/RCEP nêu trên — Buyer vẫn được hưởng cước all-in-one và Form E/RCEP, chỉ khác là phần pháp lý nhập khẩu do công ty ủy thác chịu trách nhiệm. Phù hợp đặc biệt với các ngành hàng có điều kiện (mỹ phẩm, thực phẩm, vật liệu xây dựng, hóa chất, thiết bị điện) cần công bố/hợp quy phức tạp.",
      "Bảng compliance hợp chuẩn/hợp quy theo ngành (công ty ủy thác chịu trách nhiệm thực hiện): • Mỹ phẩm / Thực phẩm → công bố mỹ phẩm / công bố An toàn vệ sinh thực phẩm (ATVSTP). • Vật liệu xây dựng (VLXD) / Hóa chất → công bố hợp quy + dấu CR + khai báo hóa chất. • Thiết bị điện / Đồ gia dụng → dán nhãn năng lượng. Buyer chỉ cần cung cấp thông tin sản phẩm; công ty ủy thác do VGEA chỉ định sẽ hoàn tất hồ sơ tương ứng theo ngành để hàng được lưu thông hợp pháp tại Việt Nam.",
    ],
    pullQuote: {
    ...
    checklist: [
      ...
      "Nhập khẩu ủy thác qua công ty do VGEA chỉ định — lo hợp chuẩn/hợp quy theo ngành",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "MIỄN PHÍ HOÀN TOÀN cho Buyer. Cybersilkroads thu phí dịch vụ 2% trên giá trị đơn hàng phát sinh từ Supplier (theo Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam, chia sẻ doanh thu theo kết quả) khi giao dịch thành công. Buyer chỉ trả: giá hàng (theo PO với NCC) + cước DDP (transparent breakdown). Không có phí thành viên, phí giao dịch, phí trung gian, phí kiểm định tại chỗ (miễn phí cho đơn ≥$5K).",
      },
    ],
    related: [
  ...
  "payment-protection": {
    ...
    sectionTitles: ["Cơ chế Bảo đảm Giao dịch", "Hai lớp bảo vệ — Pháp lý & Thanh toán", "Khi có sự cố", "Phương án xử lý"],
    paragraphs: [
      ...
      "Với những đơn nhập khẩu chính ngạch, an toàn của bạn được bảo vệ hai lớp song song. Lớp thanh toán là tài khoản trung gian nói trên. Lớp pháp lý là Công ty Thương mại ủy thác do VGEA chỉ định — đứng tên hợp đồng phân phối, đứng tên nhập khẩu, lo trọn thủ tục hợp chuẩn/hợp quy theo từng ngành hàng, đảm bảo hàng về có đầy đủ hồ sơ hợp pháp. Buyer vừa được giữ tiền an toàn cho tới khi nhận hàng đúng, vừa được một pháp nhân Việt Nam chịu trách nhiệm pháp lý cho lô hàng — an toàn pháp lý và an toàn thanh toán trong cùng một giao dịch.",
    ...
    checklist: [
      ...
      "Công ty Thương mại ủy thác do VGEA chỉ định lo pháp lý nhập khẩu + hợp chuẩn/hợp quy",
    ],
    related: [
      { label: "Khiếu nại & tranh chấp", href: "/info/disputes" },
  ...
  "audit-process": {
    ...
    sectionTitles: [
      ...
      "8b. Site Visit — Thẩm định đại lý Việt Nam (chiều thứ hai)",
    ...
    paragraphs: [
      ...
      "Thẩm định 2 chiều — bên cạnh audit nhà máy Trung Quốc, CSR thực hiện thêm Site Visit để thẩm định đại lý Việt Nam trước khi cho phép tham gia mạng lưới phân phối. Đội thẩm định đến tận nơi và chấm theo 4 tiêu chí cốt lõi: (1) Kho bãi & logistics — diện tích kho thực tế, điều kiện bảo quản hàng, năng lực xuất nhập và giao hàng last-mile, hệ thống quản lý tồn kho. (2) Showroom — không gian trưng bày sản phẩm thực, mức độ chuyên nghiệp, vị trí tiếp cận khách hàng. (3) Nhân sự — quy mô và năng lực đội ngũ bán hàng, kỹ thuật, chăm sóc khách hàng; tính ổn định nhân sự. (4) Lượng khách thực tế — lưu lượng khách hàng đến showroom/đặt hàng, tệp khách hàng đại lý đang phục vụ, chứng minh nhu cầu thị trường thật chứ không phải đại lý 'ảo'. Site Visit đại lý Việt Nam và audit nhà máy Trung Quốc tạo thành thẩm định 2 chiều — đảm bảo cả đầu cung (nhà máy TQ) và đầu cầu (đại lý VN) đều thực và đủ năng lực, trước khi CSR đứng ra kết nối.",
    ...
    checklist: [
      ...
      "🤝 Thẩm định 2 chiều — Site Visit đại lý VN: kho bãi & logistics · showroom · nhân sự · lượng khách thực tế",
  ...
  "trade-assurance": {
    ...
    quickFacts: [
      ...
      { label: "Phí dịch vụ NCC", value: "2% / đơn" },
    ...
    paragraphs: [
      ...
      "Mức phí và giới hạn: Buyer 0% phí — Cybersilkroads không thu thêm. NCC trả phí dịch vụ 2% trên giá trị đơn hàng phát sinh theo 'Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam' (chia sẻ doanh thu theo kết quả) — đã bao gồm trong giá list công khai (không phải phí ẩn); khách hàng do CSR giới thiệu được bảo hộ 5 năm, hành vi né phí bị phạt 8% giá trị đơn. Giới hạn mỗi đơn: $1.000.000 cho tier Free và Pro buyer, $5.000.000 cho tier Enterprise (đã KYC doanh nghiệp đầy đủ). Giới hạn theo năm: $5M/buyer/năm cho Free + Pro, $50M/năm cho Enterprise — vượt phải mở contract riêng và tài khoản trung gian qua Bank of China branch Quảng Châu trực tiếp. Đối tác ngân hàng đầu Việt Nam: Vietcombank (chi nhánh HCM Sở giao dịch + HN Trần Quang Khải), BIDV (HCM Quận 1 + HN Hai Bà Trưng); đầu Trung Quốc: Bank of China chi nhánh Quảng Châu Tianhe và Thâm Quyến Futian. Số liệu 2025: Cybersilkroads đã bảo vệ $42.7M giá trị đơn cho 1,840 buyer Việt Nam, tỷ lệ dispute 2.3%, thời gian giải quyết trung bình 11 ngày làm việc, tỷ lệ buyer được hoàn tiền (full hoặc partial) 87% trong các vụ có evidence đầy đủ.",
    ],
    pullQuote: {
    ...
    checklist: [
      ...
      "💸 Buyer trả 0% phí — NCC trả phí dịch vụ 2% (Hợp đồng Quảng bá & Kết nối khách hàng Việt Nam) đã gồm trong giá",
  ...
  "api-integration": {
    ...
    sectionTitles: [
      ...
      "Đồng bộ catalog nhà máy Trung Quốc (API catalog)",
    ...
    paragraphs: [
      ...
      "Đồng bộ catalog nhà máy Trung Quốc — đây là tính năng lõi giúp Cybersilkroads có chiều sâu hàng hoá: catalog của các nhà máy Trung Quốc được cắm API đồng bộ real-time vào nền tảng, không phải nhập tay từng SKU. Pipeline đồng bộ thực hiện 4 việc tự động cho mỗi sản phẩm kéo về: (1) Real-time sync — khi nhà máy cập nhật sản phẩm, giá, tồn kho ở hệ thống gốc, thay đổi được đẩy về CSR trong vòng vài phút (delta sync 5-15 phút, full reconcile hàng đêm) để buyer Việt Nam luôn thấy dữ liệu mới nhất. (2) Tự dịch tiếng Việt — tên sản phẩm, mô tả, thông số kỹ thuật được dịch tự động sang tiếng Việt (engine dịch chuyên ngành + hậu kiểm), buyer không phải đọc tiếng Trung. (3) Chuẩn hóa hình ảnh & thông số — ảnh được chuẩn hoá kích thước/định dạng, thông số kỹ thuật và MOQ (số lượng đặt tối thiểu) được map về schema thống nhất của CSR để so sánh giữa các nhà máy. (4) Khung giá chiết khấu theo số lượng — các bậc giá (price tier theo quantity break) của nhà máy được giữ nguyên cấu trúc và hiển thị minh bạch, để buyer thấy giá giảm dần theo khối lượng đặt. Endpoint liên quan: GET /catalog (danh mục, brands, certifications) và GET /products?expand=pricing,moq để pull bậc giá + MOQ đã chuẩn hoá; webhook product.published, price.changed, product.low_stock cho cập nhật event-driven.",
    ...
    checklist: [
      ...
      "🔄 Catalog nhà máy TQ cắm API sync real-time — tự dịch tiếng Việt, chuẩn hoá ảnh/thông số/MOQ/bậc giá",
