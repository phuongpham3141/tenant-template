...
const TOPICS: Record<string, Topic> = {
  ...
  "terms-of-service": {
    ...
    paragraphs: [
      ...
      "Toàn bộ nội dung do Huayue tạo ra (giao diện, code, brand identity, tài liệu, hình ảnh original, video, blog post) thuộc bản quyền của CÔNG TY TNHH CHUỖI CUNG ỨNG HUAYUE VIỆT NAM. Người dùng được phép xem, in cho mục đích cá nhân/doanh nghiệp nội bộ; KHÔNG được sao chép, phân phối, sửa đổi, reverse-engineer mà không có văn bản đồng ý. Hình ảnh sản phẩm do Supplier upload thuộc bản quyền của Supplier — Buyer chỉ được dùng cho mục đích bán lại sản phẩm đó của Supplier (không dùng cho sản phẩm khác). Logo 'Huayuesc' và '华越供应链' đang trong quá trình đăng ký bảo hộ nhãn hiệu tại Cục Sở hữu trí tuệ Việt Nam. Cấm hành vi: scraping nền tảng (rate limit + WAF), tạo tài khoản fake hàng loạt, spam RFQ vô tổ chức, đăng nội dung vi phạm IP/khiêu dâm/bạo lực, lừa đảo Buyer khác, đe doạ/quấy rối nhân viên Huayue. Vi phạm bị xử lý theo Luật Sở hữu trí tuệ VN + Bộ luật Hình sự nếu cần.",
      "Huayue thu thập, xử lý dữ liệu cá nhân theo Chính sách bảo mật chi tiết tại /info/privacy-policy — tuân thủ NĐ 13/2023/NĐ-CP, PIPL 2021 và GDPR khi áp dụng. Người dùng có 11 quyền cơ bản (xem, sửa, xoá, hạn chế xử lý, portability, etc.) — gửi yêu cầu tới privacy@huayuesc.vn. Truyền dữ liệu xuyên biên giới VN–CN giữa trụ sở Hải Phòng và văn phòng đại diện Quảng Châu được bảo vệ qua Standard Contractual Clauses (SCCs); Huayue đang trong quá trình hoàn tất đăng ký truyền dữ liệu xuyên biên giới với Cục An toàn thông tin theo Điều 25 NĐ 13/2023. Cookies: 4 nhóm (thiết yếu / phân tích / marketing / partner), banner consent với 3 lựa chọn. Huayue KHÔNG bán dữ liệu cho data broker. Lưu giữ chứng từ giao dịch 10 năm theo Luật Quản lý thuế VN. Khi Buyer đóng tài khoản: hard-delete trong 30 ngày + cấp Certificate of Erasure nếu yêu cầu.",
    ...
    checklist: [
      ...
      "Trụ sở chính: KCN Nam Đình Vũ, cảng Hải Phòng · Văn phòng đại diện: Quảng Châu, Trung Quốc",
  ...
  "privacy-policy": {
    ...
    paragraphs: [
      "Chính sách này áp dụng cho toàn bộ dịch vụ tại Huayuesc (huayuesc.vn), bao gồm website B2B, mobile app (iOS/Android sắp ra mắt), và mọi tương tác offline với đội Huayue tại trụ sở chính Hải Phòng + văn phòng đại diện thu mua Quảng Châu. Định nghĩa: 'Dữ liệu cá nhân' = thông tin có thể nhận dạng trực tiếp/gián tiếp một cá nhân (theo Điều 2 NĐ 13/2023). 'Người dùng' = Buyer (cá nhân/doanh nghiệp Việt Nam), Supplier (NCC Trung Quốc), Visitor (chưa đăng ký). 'Bên kiểm soát dữ liệu' = CÔNG TY TNHH CHUỖI CUNG ỨNG HUAYUE VIỆT NAM (MST 0111453693, trụ sở KCN Nam Đình Vũ, cảng Hải Phòng). 'Bên xử lý dữ liệu' = các nhà cung cấp dịch vụ được ủy quyền (cloud hosting, payment processors, logistics partners). 'Đồng thuận' = sự chấp thuận có hiểu biết, tự nguyện và rõ ràng theo Điều 11 NĐ 13/2023.",
      ...
      "Huayue vận hành xuyên biên giới Việt Nam – Trung Quốc: dữ liệu Buyer Việt Nam có thể được transfer sang văn phòng đại diện thu mua tại Quảng Châu để đội Huayue hỗ trợ sourcing, audit nhà máy, kiểm hàng và xử lý dispute. Truyền dữ liệu xuyên biên giới được bảo vệ bởi 3 lớp: (i) Standard Contractual Clauses (SCCs) — văn bản nội bộ giữa trụ sở Hải Phòng và văn phòng đại diện Quảng Châu của CT TNHH Chuỗi Cung Ứng Huayue Việt Nam, tuân thủ template tham chiếu của Bộ Tư pháp Việt Nam. (ii) Encryption-in-transit — tất cả traffic VN↔CN qua TLS 1.3, certificate pinning, không thể intercept. (iii) Đăng ký Truyền dữ liệu xuyên biên giới với Cục An toàn thông tin theo Điều 25 NĐ 13/2023 — Huayue đang trong quá trình hoàn tất thủ tục đăng ký. Bạn có quyền yêu cầu Huayue KHÔNG transfer dữ liệu sang Trung Quốc — chúng tôi sẽ tôn trọng nhưng có thể giới hạn dịch vụ audit nhà máy on-site (vốn do đội Quảng Châu thực hiện).",
