...
const TOPICS: Record<string, Topic> = {
  ...
  "careers": {
    ...
    paragraphs: [
      ...
      "Một ngày tại Huayue Quảng Châu (Sourcing Manager): 8:30 đến văn phòng Tầng 3 Cảng Shuyu Chuangxing, check email từ buyer Việt Nam đêm qua. 9:00 đi nhà máy gạch porcelain tại Phật Sơn (45 phút lái xe) cùng QC Inspector — kiểm chất lượng đơn hàng 500 m² của một đại lý Hà Nội. 12:00 ăn trưa với đại diện nhà máy, đàm phán giá đơn tiếp theo. 14:30 về văn phòng, viết PI tiếng Trung gửi nhà máy + bản dịch tiếng Việt gửi buyer. 16:00 video call với đội Hải Phòng — đồng bộ trạng thái container đang trên đường. 17:30 xong việc. Một ngày tại Huayue Hải Phòng (Customs Broker): 7:30 đến KCN Nam Đình Vũ, kiểm danh sách container về cảng hôm nay. 8:30 nhận chứng từ từ Quảng Châu (BL, Packing List, Invoice, C/O Form E). 9:00 khai báo VNACCS — tích hợp trực tiếp với hệ thống Tổng cục Hải quan, lệnh thông quan thường ra trong 2-4 giờ. 13:00 phối hợp đội kho dỡ container, inspection lô hàng. 15:00 bàn giao hàng cho xe đi giao tận kho khách tại HN/HCM. 17:30 về.",
    ],
    pullQuote: {
  ...
  "disputes": {
    ...
    intro: "Buyer có quyền khiếu nại trong 7 ngày kể từ ngày nhận hàng. Huayue giải quyết theo 3 cấp: Mediation nội bộ (đội Hải Phòng + Quảng Châu) → Trọng tài VIAC → TAND Hà Nội. SLA: 6 giờ email, 1 giờ qua hotline +86 181-2225-6999.",
    icon: "⚖",
    category: "AN TOÀN GIAO DỊCH",
    quickFacts: [
    ...
    paragraphs: [
      "Cấp 1 — Mediation tại Huayue (miễn phí, 7-14 ngày): Buyer gửi khiếu nại qua dashboard hoặc support@huayuesc.vn TRONG 7 NGÀY kể từ ngày nhận hàng, kèm chứng cứ (ảnh, video, biên bản nghiệm thu, số đơn). Đội Dispute Resolution của Huayue Hải Phòng tiếp nhận trong 6 giờ, liên hệ buyer + nhà máy để xác minh. Đội Quảng Châu có thể visit nhà máy kiểm tra trực tiếp nếu cần (cho lỗi sản xuất). Quyết định trong 7 ngày làm việc với 4 phương án: (a) Hoàn 100% từ tài khoản tín thác nếu hàng sai mô tả nghiêm trọng. (b) Đổi hàng miễn phí — nhà máy sản xuất lại + free DDP về VN. (c) Bồi thường thoả thuận — giảm giá X% nếu lỗi nhỏ buyer chấp nhận giữ. (d) Credit cho đơn tiếp.",
    ...
    checklist: [
      "📞 Hotline +86 181-2225-6999 — phản hồi <1 giờ",
  ...
  "find-products": {
    ...
    paragraphs: [
      ...
      "Cách 4 — Gọi sourcing manager: hotline +86 181-2225-6999. Đội Huayue tại văn phòng Quảng Châu trực tiếp tư vấn, gửi danh sách NCC đã audit, đặt mẫu, đàm phán giá thay bạn. Cách nhanh nhất cho đơn lớn (>$10K) hoặc sản phẩm cần tuỳ chỉnh OEM.",
    ],
    related: [
  ...
  "network": {
    ...
    intro:
      "Huayue xây dựng chuỗi cung ứng dựa trên hai mạng lưới: (1) Hệ thống nhà phân phối, nhà thầu xây dựng, công ty thiết kế nội thất tại Việt Nam — đầu ra cho sản phẩm Trung Quốc; (2) Mạng lưới nhà máy đối tác và hiệp hội ngành tại Quảng Đông, Phúc Kiến, Sơn Đông — đầu vào nguồn hàng. Đây là cách Huayue triển khai dịch vụ '本地化分销渠道拓展' (phát triển kênh phân phối Việt Nam) song song với '源头精选' (tinh chọn nguồn gốc) theo brochure.",
    icon: "🤝",
    ...
    paragraphs: [
      "Mô hình chuỗi cung ứng của Huayue dựa trên hai mạng lưới đối tác bổ sung lẫn nhau. Đầu vào (nguồn hàng): chúng tôi không tự sản xuất — chúng tôi sàng lọc và hợp tác với các nhà máy hàng đầu tại 3 cluster sản xuất Trung Quốc: Quảng Đông (Phật Sơn cho gốm sứ + sanitary, Lecong cho nội thất, Trung Sơn cho đèn và đồ điện), Phúc Kiến (đá tự nhiên, sàn gỗ), Sơn Đông (cơ khí, kim khí). Đầu ra (kênh tiêu thụ): mạng lưới nhà phân phối, nhà thầu xây dựng và công ty thiết kế trang trí nội thất tại 63 tỉnh thành Việt Nam. Khác với mô hình marketplace 'mua đi bán lại', Huayue là chuỗi cung ứng B2B thật — hàng đi từ xưởng → kho ngoại quan Quảng Châu → cảng Hải Phòng → kho Nam Đình Vũ → giao tận điểm tiêu thụ cuối.",
      "Đối tác phân phối tại Việt Nam (đầu ra) gồm 4 nhóm chính: (1) <b>Đại lý phân phối VLXD</b> — chuỗi cửa hàng vật liệu xây dựng, showroom gạch men, kho VLXD theo tỉnh/thành. Huayue cung cấp giá DDP tận kho, bảo hành theo nhà máy, hỗ trợ đổi trả qua đội Hải Phòng. (2) <b>Nhà thầu xây dựng</b> — công ty xây dựng dân dụng, nhà thầu dự án bất động sản, nhà thầu nhà ở xã hội. Huayue gửi báo giá theo dự án, hỗ trợ giao theo tiến độ thi công, cung cấp sample miễn phí cho 30 bộ trở lên. (3) <b>Công ty thiết kế trang trí nội thất</b> — studio thiết kế, công ty interior design. Huayue cung cấp catalogue tiếng Việt cho từng nhãn hàng, sample wood/stone/fabric, hỗ trợ visual 3D miễn phí cho khách hàng VIP của họ. (4) <b>Đại lý điện máy & thiết bị nhà bếp</b> — chuỗi điện máy, đại lý bình nóng lạnh, đại lý nắp bồn cầu thông minh. Huayue ký hợp đồng đại lý độc quyền theo khu vực với một số thương hiệu TQ. Trở thành đối tác phân phối Huayue: gửi email partnership@huayuesc.vn kèm giấy phép kinh doanh, đội Huayue Hải Phòng visit/gọi xác minh, ký hợp đồng partnership.",
      "Đối tác nhà máy & hiệp hội ngành tại Trung Quốc (đầu vào): văn phòng đại diện Quảng Châu của Huayue (Tầng 3 Cảng Shuyu Chuangxing) là điểm tiếp xúc trực tiếp với 3 cluster sản xuất. <b>Quảng Đông</b> — Phật Sơn (佛山) là 'thủ phủ gốm sứ' với 1,200+ nhà máy gốm porcelain, sanitary, gạch men quanh các huyện Nanzhuang và Lecong; Lecong (乐从) là chợ nội thất gỗ lớn nhất TQ với 3,000+ nhà máy nội thất; Trung Sơn (中山, đặc biệt Cổ Trấn) là cluster đèn LED và đồ điện gia dụng; Đông Quan (东莞) bao trùm tủ bếp, tủ áo, gỗ MDF cao cấp. <b>Phúc Kiến</b> — Tấn Giang (晋江) chuyên đá tự nhiên và sàn gỗ kỹ thuật; Hạ Môn (厦门) cho gỗ nhập khẩu chế biến. <b>Sơn Đông</b> — Vĩnh Khang (永康) cho cơ khí ngũ kim, Tần Hoàng Đảo cho kính xây dựng. Đội sourcing Huayue duy trì quan hệ với các hiệp hội ngành địa phương (Foshan Chamber, Guangdong Federation of Industry and Commerce, các hiệp hội ngành gốm sứ và nội thất khu vực) để được giới thiệu nhà máy mới và tham gia hội chợ chuyên ngành.",
    ...
    checklist: [
      ...
      "📞 Liên hệ partnership@huayuesc.vn · +86 181-2225-6999",
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Huayue gửi báo giá DDP tận công trình cho danh mục VLXD và trang trí nội thất (gạch, sanitary, đá ốp lát, sơn, sàn gỗ). Hỗ trợ: (1) gửi sample miễn phí cho đơn ≥30 bộ, (2) giao hàng theo tiến độ thi công (chia làm nhiều đợt), (3) bảo hành theo nhà máy gốc + Huayue chịu trách nhiệm đổi trả nếu lỗi. Liên hệ sales@huayuesc.vn hoặc +86 181-2225-6999.",
      },
      {
      ...
      },
      {
        ...
        a: "Có. Mọi giao tiếp với nhà máy Trung Quốc đều do đội Huayue Quảng Châu xử lý — bạn chỉ làm việc tiếng Việt với đội Hải Phòng. Khi cần đi nhà máy trực tiếp (cho đơn lớn hoặc OEM tuỳ chỉnh), Huayue cung cấp phiên dịch chuyên ngành đi cùng.",
      },
    ],
    related: [
  ...
  "audit-process": {
    ...
    paragraphs: [
      ...
      "Bước 1 — Đăng ký & cross-check pháp lý (2-3 ngày): Nhà máy đăng ký qua /sell-on-csr hoặc được đội Huayue Quảng Châu scout tại hội chợ Canton Fair / CIFF / Foshan Pottery. Đội audit cross-check 3 nguồn dữ liệu công khai: (a) <b>Tianyancha</b> (天眼查) và <b>Qichacha</b> (企查查) — tra giấy phép kinh doanh, lịch sử thay đổi vốn, kiện tụng, blacklist. (b) <b>GACC</b> (China Customs, 中国海关) — kiểm tra license xuất khẩu thực tế và HS code đã từng khai báo. (c) <b>China Court Open Database</b> (中国裁判文书网) — án phạt hành chính, vi phạm IP, gian lận thanh toán. Nhà máy có 'red flag' (kiện tụng quá nhiều, blacklist GACC, vi phạm lao động) bị reject ngay với thư phản hồi rõ ràng.",
      "Bước 2 — Audit hồ sơ tài liệu (2-3 ngày): Nhà máy nộp đầy đủ tài liệu chính thức gồm: Business License (营业执照), Tax Registration (税务登记证), Unified Social Credit Code (统一社会信用代码), Foreign Trade Operator Registration (对外贸易经营者备案登记表), Customs Declaration Registration (报关单位注册登记证书), ISO 9001:2015 Quality Management certificate, các product certifications theo ngành (CE / RoHS / FDA / FSC / GREENGUARD / OEKO-TEX tuỳ ngành), sao kê ngân hàng 3 tháng (chứng minh dòng tiền vận hành thực — không phải shell company), bảng lương công nhân tháng gần nhất (verify số nhân lực vs claim), 30+ ảnh nhà máy, danh sách 5 khách hàng lớn nhất 3 năm gần. Đội audit cross-check trong 2-3 ngày để loại broker đội lốt và shell company.",
  ...
  "market-reports": {
    ...
    paragraphs: [
      ...
      "Phương pháp luận: triple-source validation — mọi số liệu critical có ít nhất 3 nguồn độc lập đồng thuận. Dữ liệu giá nhà máy: tổng hợp từ 20+ NCC đối tác Huayue (anonymized, chỉ aggregate) + crawl giá public từ 1688.com và Made-in-China.com + báo cáo từ hiệp hội ngành Quảng Đông (Foshan Chamber, Guangdong Federation). Tỷ giá: tỷ giá liên ngân hàng tham chiếu, PBOC fix rate, Reuters spot. Nguyên liệu: SHFE Shanghai Futures (thép, đồng, nhôm), Bloomberg cho dầu mỏ. Chính sách: Tổng cục Hải quan VN, GACC, MOFCOM, Bộ Tài chính VN. Đội ngũ biên tập: đội sourcing Quảng Châu (am hiểu nhà máy) + đội Hải Phòng (am hiểu thị trường VN) + 1 chuyên gia kinh tế đối ngoại tư vấn cố định.",
